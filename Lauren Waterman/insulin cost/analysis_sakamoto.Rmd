...
```{r}
table1(~sex + race + ethnicity + diabetes_duration + insurance + pump_user+ age + HbA1c + TIR + insulin_cost|insurance, data = analysis_ins1)
```

### Public/Private+Tricare

```{r}
table1(~sex + race + ethnicity + diabetes_duration + insurance + pump_user+ age + HbA1c + TIR + insulin_cost|insurance2, data = analysis_ins2)
```

### Emerging Adults

```{r}
table1(~sex + race + ethnicity + diabetes_duration + insurance + pump_user+ age + HbA1c+ TIR + insulin_cost|emerging_adult, data = analysis)
```

### Instate

```{r}
table1(~sex + race + ethnicity + diabetes_duration + insurance + pump_user+ age + HbA1c+ TIR + insulin_cost|instate, data = analysis %>% filter(!is.na(instate)))
...
```{r}
table1(~sex + race + ethnicity + diabetes_duration + insurance + pump_user + age + HbA1c+ TIR + insulin_cost|rationing, data = analysis %>% filter(!is.na(rationing)))
