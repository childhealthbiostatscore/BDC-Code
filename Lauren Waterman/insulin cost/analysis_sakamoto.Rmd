...
summary.rq(mod)
modmeans = emmeans(summary(mod, se = "iid", covariance = T), tau = 0.5, ~insulin_cost|rationing)
table1(~ insulin_cost | insurance*rationing, analysis %>% filter(!is.na(rationing)) %>% filter(!is.na(insurance)))
#
```
