...
alldata$temp <- ifelse(alldata$prediabetes==1 & alldata$diabetes==1,0,
                              ifelse(alldata$prediabetes==1 & alldata$diabetes==0,1,0))
# NEED TO CHECK THIS VARIABLE AFTER CC RESPONSE
...
```{r, results='asis',tidy=TRUE, echo=FALSE}
kable(tab2a,caption="Table 2.  Descriptive statistics for CGM outcomes by group.  Statistics given are N(%), mean±SD, or median (25th %ile, 75th %ile).  * denotes that the Wilcoxon test was used, and ** denotes that Fisher's exact test was used.")
```
<br>
...
```{r, results='asis',tidy=TRUE, echo=FALSE}
kable(tab2b,caption="Table 2.  Descriptive statistics for beta cell function outcomes by group, for participants with fsOGTT.  Statistics given are N(%), mean±SD, or median (25th %ile, 75th %ile).  * denotes that the Wilcoxon test was used, and ** denotes that Fisher's exact test was used.")
```
<br>
