...
cgmvars <- c("min_sensor","max_sensor","average_sensor","average_auc_per_day","excursions_over_200","avg_excur_over_140_per_day",
             ...
             "total_auc","standard_deviation","mean_amp_glycemic_ex","Calprotectin","C.Reactive.Protein","cov")
...
sigvars <- c("poc_a1c","isi","isi_cpep","odi","odi_cpep","iaucbase_glucose","iaucbase_cpep","iAUCcpep_iAUCgluc","iAUCins_iAUC_gluc","average_sensor","standard_deviation","max_sensor","average_auc_per_day","excursions_over_200","avg_excur_over_200_per_day","min_spent_over_200","excursions_over_140","avg_excur_over_140_per_day","percent_time_over_140","min_spent_over_140","mean_amp_glycemic_ex","percent_time_over_180","percent_time_over_200","cov")
l <- list()
for (var in sigvars) {
