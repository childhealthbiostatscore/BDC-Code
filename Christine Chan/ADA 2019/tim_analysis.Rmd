...
ROC analysis for % time >140 is shown below.
```{r, results='asis',tidy=TRUE, echo=FALSE}
plot(pct140_roc)
kable(pct140_res) 
...
ROC analysis for % time >180 is shown below.
```{r, results='asis',tidy=TRUE, echo=FALSE}
plot(pct180_roc)
kable(pct180_res)
...
ROC analysis for % time >200 is shown below.
...
ROC analysis for excursions >200 is shown below.
...
ROC analysis for average sensor glucose is shown below.
...
ROC analysis for maximum sensor glucose is shown below.
...
ROC analysis for SD is shown below.
...
ROC analysis for CV is shown below.
...
ROC analysis for MAGE is shown below.
