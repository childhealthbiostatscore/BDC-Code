...
if(Sys.info()["sysname"] == "Windows"){
  ...
  home_dir = "/Volumes/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Jenna Sopfe/"
}
...
```{r results='asis'}
t1 = tableby(~notest(q_score,"N", "median", "q1q3")+AgeTx+gender+Race+tanner_stage+tx_type+
...
```{r results='asis'}
vars = c("tx_type","primary_dx_cat","prep_regimen","sec_icu",
         "infections_yn","post_tx_tpn")
for (v in vars) {
  compare(df,v)
}
```
