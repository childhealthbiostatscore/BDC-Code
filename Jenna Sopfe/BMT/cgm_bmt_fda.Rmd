...
# Clean
cgm = read.csv("./Jenna Sopfe/CGM Accuracy in BMT/Data_Cleaned/Prospective HSCT CGM Data Updated 6.24.19 FULL DATA SET.csv",na.strings = "")
...
cgm$time = as.numeric(difftime(cgm$Time,cgm$time_engraft_minus_3,units = "days"))
```
