...
cgm <- left_join(cgm,events[,c("study_id","event")],by = "study_id")
...
# Write to CSV
write.csv(cgm,file = "/Users/timvigers/Desktop/BMT/cgm.csv",row.names = F,na = "")
write.csv(events,file = "/Users/timvigers/Desktop/BMT/events.csv",row.names = F,na = "")
```
