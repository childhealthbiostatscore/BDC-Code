...
```{r echo=FALSE}
cgm_serum$diff <- cgm_serum$`Serum Value` - cgm_serum$`CGM Value`
...
This table shows some summary values of the differences between serum and CGM. The first row is a summary of all 893 difference values. For row two, the mean difference was calculated for each individual sensor (n = 74). The histograms below (Figure 2) show these distributions.
...
```{r echo=FALSE}
hist(cgm_serum$diff,xlab = "Serum Value - CGM Value",main = "")
```
...
This table shows the number and percentage of sensors with a positive, negative, or 0 average difference between serum and CGM.
...
ceg + scale_color_discrete(limits = c("A","B","C","D","E"))

# ceg + scale_color_manual(values = c("A" = "blue","B" = "blue","C" = "blue","D" = "red","E" = "red"),
#                          drop = F,breaks = c("A","B","C","D","E"))
```
