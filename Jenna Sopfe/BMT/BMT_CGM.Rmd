...
t1 <- as.data.frame(print(t1, nonnormal = c("AgeTx","bmi_percentile"),printToggle = F,showAllLevels = T))
t1 <- cbind(new = NA,t1)
...
cgm <- read.csv("/Volumes/som/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Jenna Sopfe/BMT/Data_Cleaned/Prospective HSCT CGM Data Updated 6.24.19 FULL DATA SET.csv")
serum <- read.csv("/Volumes/som/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Jenna Sopfe/BMT/Data_Cleaned/Glucose_Monitoring_061019 edited 6.25.19.csv",na.strings = "") %>% 
