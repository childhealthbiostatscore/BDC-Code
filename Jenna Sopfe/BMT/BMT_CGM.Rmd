...
# Wide to long
temp <- reshape(cgm_data,idvar = "study_id",
                varying = list(c("sens1_place","plt1","transfuse1","bleed1","sens1_remove","sens1_reason"),
                               c("sens2_place","plt2","transfuse2","bleed2","sens2_remove","sens2_reason"),
                               c("sens3_place","plt3","transfuse3","bleed3","sens3_remove","sens3_reason"),
                               c("sens4_place","plt4","transfuse4","bleed4","sens4_remove","sens4_reason"),
                               c("sens5_place","plt5","transfuse5","bleed5","sens5_remove","sens5_reason"),
                               c("sens6_place","plt6","transfuse6","bleed6","sens6_remove","sens6_reason")),
