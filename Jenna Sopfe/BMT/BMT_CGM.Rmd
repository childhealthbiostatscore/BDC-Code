...
# Days from Tx
cgm$Days <- as.numeric(difftime(cgm$Time,cgm$Tx_date,units = "days"))
...
write.csv(cgm_serum,file = "/Volumes/som-1/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Jenna Sopfe/BMT/Data_Cleaned/cgm_serum_comparison.csv",row.names = F,na="")
```
