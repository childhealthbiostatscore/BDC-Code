...
plot(bg_depress_mod)
kable(anova(bg_depress_mod),caption = "Overall Effects")
kable(summary(bg_depress_mod)$coefficients,caption = "Coefficients")
```
...
plot(carb_depress_mod)
kable(anova(carb_depress_mod),caption = "Overall Effects")
kable(summary(carb_depress_mod)$coefficients,caption = "Coefficients")
```
...
plot(bolus_depress_mod)
kable(anova(bolus_depress_mod),caption = "Overall Effects")
kable(summary(bolus_depress_mod)$coefficients,caption = "Coefficients")
```
...
plot(highbg_depress_mod)
kable(anova(highbg_depress_mod),caption = "Overall Effects")
kable(summary(highbg_depress_mod)$coefficients,caption = "Coefficients")
```
...
plot(extremebg_depress_mod)
kable(anova(extremebg_depress_mod),caption = "Overall Effects")
kable(summary(extremebg_depress_mod)$coefficients,caption = "Coefficients")
```
...
plot(bg_help_mod)
kable(anova(bg_help_mod),caption = "Overall Effects")
kable(summary(bg_help_mod)$coefficients,caption = "Coefficients")
```
...
plot(carb_help_mod)
kable(anova(carb_help_mod),caption = "Overall Effects")
kable(summary(carb_help_mod)$coefficients,caption = "Coefficients")
```
...
plot(bolus_help_mod)
kable(anova(bolus_help_mod),caption = "Overall Effects")
kable(summary(bolus_help_mod)$coefficients,caption = "Coefficients")
```
...
plot(highbg_help_mod)
kable(anova(highbg_help_mod),caption = "Overall Effects")
kable(summary(highbg_help_mod)$coefficients,caption = "Coefficients")
```
...
plot(extremebg_help_mod)
kable(anova(extremebg_help_mod),caption = "Overall Effects")
kable(summary(extremebg_help_mod)$coefficients,caption = "Coefficients")
```
...
plot(bg_maint_mod)
kable(anova(bg_maint_mod),caption = "Overall Effects")
kable(summary(bg_maint_mod)$coefficients,caption = "Coefficients")
```
...
plot(carb_maint_mod)
kable(anova(carb_maint_mod),caption = "Overall Effects")
kable(summary(carb_maint_mod)$coefficients,caption = "Coefficients")
```
...
plot(bolus_maint_mod)
kable(anova(bolus_maint_mod),caption = "Overall Effects")
kable(summary(bolus_maint_mod)$coefficients,caption = "Coefficients")
```
...
plot(highbg_maint_mod)
kable(anova(highbg_maint_mod),caption = "Overall Effects")
kable(summary(highbg_maint_mod)$coefficients,caption = "Coefficients")
```
...
plot(extremebg_maint_mod)
kable(anova(extremebg_maint_mod),caption = "Overall Effects")
kable(summary(extremebg_maint_mod)$coefficients,caption = "Coefficients")
```
...
plot(bg_soc_mod)
kable(anova(bg_soc_mod),caption = "Overall Effects")
kable(summary(bg_soc_mod)$coefficients,caption = "Coefficients")
```
...
plot(carb_soc_mod)
kable(anova(carb_soc_mod),caption = "Overall Effects")
kable(summary(carb_soc_mod)$coefficients,caption = "Coefficients")
```
...
plot(bolus_soc_mod)
kable(anova(bolus_soc_mod),caption = "Overall Effects")
kable(summary(bolus_soc_mod)$coefficients,caption = "Coefficients")
```
...
plot(highbg_soc_mod)
kable(anova(highbg_soc_mod),caption = "Overall Effects")
kable(summary(highbg_soc_mod)$coefficients,caption = "Coefficients")
```
...
plot(extremebg_soc_mod)
kable(anova(extremebg_soc_mod),caption = "Overall Effects")
kable(summary(extremebg_soc_mod)$coefficients,caption = "Coefficients")
```
