...
LASSO regression using AIC to determine the optimal shrinkage parameter agrees with our model selection, which is a good sign. This is not a necessary step in the process, but I (Tim) have been wanting to try it out and this seemed like a good opportunity. 