...
This outcome was dichotomized in order to obtain approximately even groups
...
df$Parent.Social.Consequences.Subscale.of.HFS = 
  as.numeric(cut2(df$Parent.Social.Consequences.Subscale.of.HFS,g = 2))-1
mod = fit_mod(outcome = "Parent.Worry.Helplessness.Subscale.of.HFS",fam = "binomial")
kable(Anova(mod,type = "III"),caption = "Type III Tests of Fixed Effects")
kable(summary(mod)$coefficients,caption = "Mixed Model Coefficients")
```
...
df$Parent.GAD.7.Score = 
  as.numeric(cut2(df$Parent.GAD.7.Score,g = 2))-1
...
# Questions for Kim and Holly
 ...
 2. How should we dichotomize the last two outcomes? What makes the most clinical sense?