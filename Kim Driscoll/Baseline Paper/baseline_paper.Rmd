...
# PDS
kable(pds_boys,col.names = res_names,caption = "PDS - Boys")
kable(pds_girls,col.names = res_names,caption = "PDS - Girls")
# Meter
kable(meter,col.names = res_names,caption = "Meter")
# Pump
kable(pump,col.names = res_names,caption = "tdk")
# BGMIPR
kable(bgmipr,col.names = res_names,caption = "BGMIPR")
# DFRQ
kable(dfrq,col.names = res_names,caption = "DFRQ")
```
