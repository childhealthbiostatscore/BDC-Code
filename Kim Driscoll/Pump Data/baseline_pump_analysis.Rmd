...
# Summary variables.
# Import data
indir <- paste(pathstart,"som/PEDS/RI Biostatistics Core/Shared/Laura Tim projects/Kim Driscoll/Baseline Pump Paper/Data_Cleaned/Pump Files Cleaned",sep="")
outdir <- paste(pathstart,"som/PEDS/RI Biostatistics Core/Shared/Laura Tim projects/Kim Driscoll/Baseline Pump Paper/Data_Cleaned/",sep="")
files <- list.files(indir,full.names = T)
