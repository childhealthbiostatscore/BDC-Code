...
# Summary variables.
# Import data
indir <- "/Volumes/som-1/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Kim Driscoll/Baseline Pump Paper/Data_Cleaned/untitled folder/"
...
# Iterate through each BG reading
  ...
  for (r in bgreadings) {
    ...
    if (TRUE %in% (carbtimes %in% time.range.15)) {
      ...
      if (bg %in% 250:400) {veryhighBG_with_carb <- veryhighBG_with_carb + 1}
      if (bg %in% 250:400 & (TRUE %in% (bolus.times %in% time.range.15))) {
...
# As percentages in summary table
  ...
  summary[f,"lowBG_with_carb_no_bolus"] <- (lowBG_followed_by_bolus/(lowBGcount-lowBG_with_carb))*100
  summary[f,"lowBG_with_carb_and_bolus"] <- (lowBG_with_carb/lowBG_with_carb_bolus)*100
  
  summary[f,"intargetBG_with_carb_no_bolus"] <- (intargetBG_followed_by_bolus/(intargetBGcount-intargetBG_with_carb))*100
  summary[f,"intargetBG_with_carb_and_bolus"] <- (intargetBG_with_carb/intargetBG_with_carb_bolus)*100
  
  summary[f,"highBG_with_carb_no_bolus"] <- (highBG_followed_by_bolus/(highBGcount-highBG_with_carb))*100
  summary[f,"highBG_with_carb_and_bolus"] <- (highBG_with_carb/highBG_with_carb_bolus)*100
  
  summary[f,"veryhighBG_with_carb_no_bolus"] <- (veryhighBG_followed_by_bolus/(veryhighBGcount-veryhighBG_with_carb))*100
  summary[f,"veryhighBG_with_carb_and_bolus"] <- (veryhighBG_with_carb/veryhighBG_with_carb_bolus)*100
  
  summary[f,"extremeBG_with_carb_no_bolus"] <- (extremeBG_followed_by_bolus/(extremeBGcount-extremeBG_with_carb))*100
  summary[f,"extremeBG_with_carb_and_bolus"] <- (extremeBG_with_carb/extremeBG_with_carb_bolus)*100
