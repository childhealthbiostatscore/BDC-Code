...
```{r}
outcome = "success"
predictors = colnames(df)[which(!colnames(df) %in% c("record_id","success"))]
...
mod$data = NULL
save(mod,file = "C:/Users/timvigers/Documents/GitHub/BDC-Code/Greg Forlenza/CIQ Predictive Model/shiny_app/ciq_prediction/final_mod.RData")
```
