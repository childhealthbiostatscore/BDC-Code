...
levels(data$demographics_pumphx.factor)=c("< 6 months","< 6 months",">= 6 months",">= 6 months",">= 6 months",">= 6 months","< 6 months")
levels(data$demographics_cgmhx.factor)=c("< 6 months","< 6 months",">= 6 months",">= 6 months",">= 6 months",">= 6 months","< 6 months")
