...
t1_form <- "interaction(cohort,success)~kwt(am_final)+hba1c+kwt(m1_sensor_wear)+m3_sensor_wear+m1_time_am+m3_time_am+m1_tir+m3_tir+demographics_t1d_duration+demographics_age+demographics_sex.factor+demographics_insurance.factor+demographics_race.factor+demographics_ethnicity.factor+demographics_cgmhx.factor+demographics_pumphx.factor"
