...
num_vars <- c("Baseline.A1c","Auto.Mode...1","Time.in.range.....1","Age","X..Boluses.day...Visit")
...
t1_form <- "Cohort~Age+kwt(am_final)+hba1c+kwt(m1_sensor_wear)+kwt(m3_sensor_wear)+kwt(m1_time_am)+kwt(m3_time_am)+m1_tir+m3_tir+kwt(demographics_t1d_duration)+success+Age+demographics_sex.factor+fe(demographics_insurance.factor)+demographics_race.factor+fe(demographics_ethnicity.factor)"
...
# Table 1 design formula. Visually non-normal variables tested with K-W, categorical
# variables with < 5 in any cell tested with Fisher's exact
t1_form <- "interaction(Cohort,success)~Age+kwt(am_final)+hba1c+kwt(m1_sensor_wear)+kwt(m3_sensor_wear)+kwt(m1_time_am)+kwt(m3_time_am)+m1_tir+m3_tir+kwt(demographics_t1d_duration)+Age+demographics_sex.factor+fe(demographics_insurance.factor)+demographics_race.factor+fe(demographics_ethnicity.factor)"
