...
t1_form <- "cohort~kwt(am_final)+hba1c+kwt(m1_sensor_wear)+kwt(m3_sensor_wear)+kwt(m1_time_am)+kwt(m3_time_am)+m1_tir+m3_tir+kwt(demographics_t1d_duration)+demographics_age+demographics_sex.factor+fe(demographics_insurance.factor)+demographics_race.factor+fe(demographics_ethnicity.factor)"

t1 <- tableby(as.formula(t1_form),data = t1_df)
