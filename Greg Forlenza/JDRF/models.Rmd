...
Technically the sensor wear model is better by both AIC and ROC AUC, but both appear to be good models. For now I'll continue using sensor wear
...
model1 <- 
  ...
  scale(m1_tir,scale=F) + demographics_age + demographics_sex.factor")
model3 <- 
  as.formula("success ~ scale(hba1c,scale=F) + scale(m3_sensor_wear,scale=F) + 
