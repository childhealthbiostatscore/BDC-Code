...
t1_df = t1_df %>% 
  unite(paid_total,c_paid_total,ya_paid_total,na.rm = T) %>%
  unite(hfs_behave_total,c_hfs_behave_total,ya_hfs_behave_total,na.rm = T) %>%
  unite(hfs_worry_total,c_hfs_worry_total,ya_hfs_worry_total,na.rm = T)
t1_df[t1_df==""] = NA
...
t1_form <- "Cohort~Age+kwt(am_final)+hba1c+kwt(m1_sensor_wear)+kwt(m3_sensor_wear)+kwt(m1_time_am)+kwt(m3_time_am)+m1_tir+m3_tir+kwt(demographics_t1d_duration)+success+Age+paid_total+hfs_behave_total+hfs_worry_total+demographics_sex.factor+fe(demographics_insurance.factor)+demographics_race.factor+fe(demographics_ethnicity.factor)+demographics_pumphx.factor+demographics_cgmhx.factor"
...
summary(t1,labelTranslations = 
          list(am_final = "AM Use at Final Visit",hba1c = "Baseline HbA1c",
               ...
               hfs_worry_total = "HFS Worry Total",
               success = "Success",
...
# Table 1 design formula. Visually non-normal variables tested with K-W, categorical
# variables with < 5 in any cell tested with Fisher's exact
t1_form <- "interaction(Cohort,success)~Age+kwt(am_final)+hba1c+kwt(m1_sensor_wear)+kwt(m3_sensor_wear)+kwt(m1_time_am)+kwt(m3_time_am)+m1_tir+m3_tir+kwt(demographics_t1d_duration)+Age+paid_total+hfs_behave_total+hfs_worry_total+demographics_sex.factor+fe(demographics_insurance.factor)+demographics_race.factor+fe(demographics_ethnicity.factor)+demographics_pumphx.factor+demographics_cgmhx.factor"
