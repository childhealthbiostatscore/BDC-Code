...
# plots 
## means df
plotaa = data.frame(mod_aa_means$emmeans)
plot30 = data.frame(mod_30_means$emmeans)
plot18 = data.frame(mod_18_means$emmeans)
plot22 = data.frame(mod_22_means$emmeans)
plot25 = data.frame(mod_25_means$emmeans)
plot30 = data.frame(mod_30_means$emmeans)
```
