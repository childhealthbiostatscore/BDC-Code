...
alldata <- read.csv("/home/timvigers/OneDrive/Vigers/BDC/Todd Alonso/A1c and TIR/Raw data/Peds_T1D_5groups_5_11_withDKAcol.csv",na.strings = c(" ","","NULL","#VALUE","#VALUE!","?"))
...
dka_sh <- read.csv("/home/timvigers/OneDrive/Vigers/BDC/Todd Alonso/A1c and TIR/Raw data/Peds_T1D_5groups_5_11_11152021 with SH and DKA event count.csv",na.strings = c(" ","","NULL","#VALUE","#VALUE!","?","N/A"))
...
pcs = data.frame("CGMMeanGlucose" = pc1_mean,"A1C_Value" = pc1_a1c,
                 "CGMInRange" = pc1_tir)
# Base plot
fig <- plot_ly(pca_data, x = ~CGMMeanGlucose, y = ~A1C_Value, z = ~CGMInRange, 
               type = 'scatter3d', mode = 'markers',marker = list(size = 1))
# Add PC1
fig = fig %>% add_trace(data = pcs,
...
# Save
ggsave("/home/timvigers/OneDrive/Vigers/BDC/Todd Alonso/A1c and TIR/Figures/figure_4a.png",
       plot = p1, width = 9,height = 6,units = "in")
ggsave("/home/timvigers/OneDrive/Vigers/BDC/Todd Alonso/A1c and TIR/Figures/figure_4b.png",
       plot = p2, width = 9,height = 6,units = "in")
ggsave("/home/timvigers/OneDrive/Vigers/BDC/Todd Alonso/A1c and TIR/Figures/figure_4c.png",
