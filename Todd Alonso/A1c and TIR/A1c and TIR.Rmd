...
alldata$CGMUsePercent_group <- ifelse(is.na(alldata$CGMUsePercent),NA,
                                      ifelse(alldata$CGMUsePercent<1,"<1% CGM use",
...
Patient recorded as not on CGM were excluded.  Pearson's correlation coefficient and generalized linear models were used to examine the relationship between HbA1c and CGM time in range.
...
Model summary. Caveat: amount of CGM use is missing for 186 patients, including the 2 who had 2 DKA events.
...
Model summary. Caveat: amount of CGM use is missing for 186 patients, including 1 who had 1 SH event and 1 who had 2 SH events.
