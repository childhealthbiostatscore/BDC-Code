...
a1c_predict_switch = a1c_predict_switch %>% filter(tech_group_change %in% c("CGM + Pump/HCL", "CGM + Pump/Pump Alone", "Pump Alone/None"))

ggplot(data = a1c_predict_switch)+
...
a1c_predict_switch %>% filter(tech_group_change %in% c("CGM + Pump/HCL", "CGM + Pump/Pump Alone", "Pump Alone/None"))%>% group_by(tech_group_change, time_group) %>% summarise(pred_mean = mean(grpmean))
