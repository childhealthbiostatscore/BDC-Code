...
a1c_tech_test = read_excel("S:/Laura/BDC/Projects/Todd Alonso/A1c trends 2017 to 2021 by tech/Data raw/Change in A1c 2017 to 2021_new.xlsx")
a1c_tech = left_join(a1c_tech_test, a1c_tech)

rm(a1c_tech_test, a1c_tech_2016, a1c_tech_2020)
```
...
The average A1c increased by 0.37 (95% CI: 0.11, 0.63) in the Pump Only groups (p = 0.01), and increased by 0.78 (95% CI: 0.52, 1.04) in the No Tech group (p < 0.0001). There was no significant difference in the time periods within the HCL, CGM+Pump, or CGM only group (p = 0.96, 0.95, 1.00 respectively) 
...
The average A1c increased by 0.77 (95% CI: 0.41, 1.13) in the No Tech group (p < 0.0001). There was no significant difference in the time periods within the HCL (p = 0.95), CGM + Pump (p = 0.36), CGM only group (p = 0.99) or the pump only group (p = 0.52) 
...
There was a significant difference in A1c for patients who went from the CGM + Pump to HCL (decreased by 0.46p, p = 0.002)
There was a significant difference in A1c for patients who went from the CGM + Pump to Pump only (increased by 0.961, p = 0.02)
