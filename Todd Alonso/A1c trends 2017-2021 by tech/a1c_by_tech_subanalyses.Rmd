...
The average A1c increased by 0.36 (95% CI: 0.10, 0.62) in the Pump Only groups (p = 0.01), and increased by 0.77 (95% CI: 0.51, 1.03) in the No Tech group (p < 0.0001). There was no significant difference in the time periods within the HCL, CGM+Pump, or CGM only group (p = 0.96, 0.84, 1.00 respectively) 
...
The average A1c increased by 0.77 (95% CI: 0.41, 1.12) in the No Tech group (p < 0.0001). There was no significant difference in the time periods within the HCL (p = 0.95), CGM + Pump (p = 0.42), CGM only group (p = 0.99) or the pump only group (p = 0.46) 
...
There was a significant difference in A1c for patients who went from the CGM + Pump to Pump only (increased by 0.948, p = 0.02)
