...
The average A1c Increased by 0.39 (95% CI: 0.17, 0.62) in the Pump Only groups (p = 0.003), and increased by 0.42 (95% CI: 0.23, 0.62) in the No Tech group (p < 0.0001). There was no significant difference in the time periods within the HCL group (p = 0.995), CGM + Pump group (p = 0.527), or CGM only group (p = 0.679) 
...
# overall
a1c_predict %>% group_by( time_group) %>% summarise(pred_mean = mean(a1cpred_all))
