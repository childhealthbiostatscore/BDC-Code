...
The average A1c Increased by 0.36 (95% CI: 0.14, 0.58) in the Pump Only groups (p = 0.008), and increased by 0.42 (95% CI: 0.19, 0.57) in the No Tech group (p < 0.0001). There was no significant difference in the time periods within the HCL group (p = 0.997), CGM + Pump group (p = 0.421), or CGM only group (p = 0.419) 
