...
alldata$temp <- NA
alldata[alldata$OnsetDate >= dmy("01-Jul-2017") & alldata$OnsetDate <= dmy("13-Oct-2017"),]$temp <- "Pre1"
alldata[alldata$OnsetDate >= dmy("01-Jul-2018") & alldata$OnsetDate <= dmy("13-Oct-2018"),]$temp <- "Pre2"
alldata[alldata$OnsetDate >= dmy("01-Jul-2019") & alldata$OnsetDate <= dmy("13-Oct-2019"),]$temp <- "Pre3"
alldata[alldata$OnsetDate >= dmy("01-Jul-2020") & alldata$OnsetDate <= dmy("13-Oct-2020"),]$temp <- "Post"
...
July 1-Oct 13 (2017-2019) was used as the pre-pandemic period.  7/1/20-10/13/20 was used as the post-pandemic period.
