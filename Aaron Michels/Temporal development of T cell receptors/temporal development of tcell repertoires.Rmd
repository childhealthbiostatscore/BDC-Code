...
seroconvert <- read.csv("./Aaron Michels/Temporal development of T-cell repertoires/Data raw/Aab+ visits.csv",na.strings = c(""," ","N/A"))
seroconvert$temp <- word(seroconvert$ID,1,sep = "-")
seroconvert$temp <- str_remove(seroconvert$temp,"^0+")
seroconvert$Patient <- as.numeric(seroconvert$temp)
seroconvert$seroconvert_visit <- seroconvert$Aab..visit
seroconvert$temp <- NULL
seroconvert_complete <- expand(seroconvert,Patient,Aab..visit)
seroconvert$Aab..visit <- NULL
seroconvert_complete <- seroconvert_complete %>% arrange(Patient,Aab..visit)
seroconvert_complete$Aab..visit <- ifelse(is.na(seroconvert_complete$Aab..visit),4,seroconvert_complete$Aab..visit)
seroconvert_complete <- merge(seroconvert_complete,seroconvert,by="Patient")
seroconvert_complete$seroconverted <- ifelse(seroconvert_complete$Aab..visit>=seroconvert_complete$seroconvert_visit,1,0)
seroconvert_complete$seroconverted <- ifelse(is.na(seroconvert_complete$seroconverted),0,seroconvert_complete$seroconverted)
seroconvert_complete$Time.point <- seroconvert_complete$Aab..visit
seroconvert_complete <- seroconvert_complete[,c("Patient","Time.point","seroconverted")]

# data for fig 1b
dat1 <- read.csv("./Aaron Michels/Temporal development of T-cell repertoires/Data raw/fig_1b_s2.csv",na.strings = c(""," ","X"))
# wide to long
...
# data for fig 1c
dat1_age <- read.csv("./Aaron Michels/Temporal development of T-cell repertoires/Data raw/fig_1b_s2_age.csv",na.strings = c(""," ","X"))
...
# data for fig 4a
dat4a_aet <- read.csv("./Aaron Michels/Temporal development of T-cell repertoires/Data raw/fig 4a %AET.csv",na.strings = c(""," ","X"))
...
dat4a_aet <- merge(dat4a_aet,seroconvert_complete,by=c("Patient","Time.point"),all.x = T,all.y = F)
dat4a_aet$seroconverted <- ifelse(dat4a_aet$Diagnosis=="Control",0,dat4a_aet$seroconverted)

dat4a_set <- read.csv("./Aaron Michels/Temporal development of T-cell repertoires/Data raw/fig 4a S%ET.csv",na.strings = c(""," ","X"))
...
dat4a_set <- merge(dat4a_set,seroconvert_complete,by=c("Patient","Time.point"),all.x = T,all.y = F)
dat4a_set$seroconverted <- ifelse(dat4a_set$Diagnosis=="Control",0,dat4a_set$seroconverted)

dat4a_sat <- read.csv("./Aaron Michels/Temporal development of T-cell repertoires/Data raw/fig 4a SA%T.csv",na.strings = c(""," ","X"))
...
dat4a_sat <- merge(dat4a_sat,seroconvert_complete,by=c("Patient","Time.point"),all.x = T,all.y = F)
dat4a_sat$seroconverted <- ifelse(dat4a_sat$Diagnosis=="Control",0,dat4a_sat$seroconverted)

dat4a_sae <- read.csv("./Aaron Michels/Temporal development of T-cell repertoires/Data raw/fig 4a SAE%.csv",na.strings = c(""," ","X"))
...
dat4a_sae <- merge(dat4a_sae,seroconvert_complete,by=c("Patient","Time.point"),all.x = T,all.y = F)
dat4a_sae$seroconverted <- ifelse(dat4a_sae$Diagnosis=="Control",0,dat4a_sae$seroconverted)

# read in data for fig s1
dats1 <- read.csv("./Aaron Michels/Temporal development of T-cell repertoires/Data raw/fig s1.csv",na.strings = c(""," ","X"))
...
# fig S6
dats6_lqs <- read.csv("./Aaron Michels/Temporal development of T-cell repertoires/Data raw/fig s6a %LQS.csv",na.strings = c(""," ","X"))
...
dats6_lqs <- merge(dats6_lqs,seroconvert_complete,by=c("Patient","Time.point"),all.x = T,all.y = F)
dats6_lqs$seroconverted <- ifelse(dats6_lqs$Diagnosis=="Control",0,dats6_lqs$seroconverted)

dats6_sqs <- read.csv("./Aaron Michels/Temporal development of T-cell repertoires/Data raw/fig s6a S%QS.csv",na.strings = c(""," ","X"))
...
dats6_sqs <- merge(dats6_sqs,seroconvert_complete,by=c("Patient","Time.point"),all.x = T,all.y = F)
dats6_sqs$seroconverted <- ifelse(dats6_sqs$Diagnosis=="Control",0,dats6_sqs$seroconverted)

dats6_sls <- read.csv("./Aaron Michels/Temporal development of T-cell repertoires/Data raw/fig s6a SL%S.csv",na.strings = c(""," ","X"))
...
dats6_sls <- merge(dats6_sls,seroconvert_complete,by=c("Patient","Time.point"),all.x = T,all.y = F)
dats6_sls$seroconverted <- ifelse(dats6_sls$Diagnosis=="Control",0,dats6_sls$seroconverted)

dats6_slq <- read.csv("./Aaron Michels/Temporal development of T-cell repertoires/Data raw/fig s6a SLQ%.csv",na.strings = c(""," ","X"))
...
dats6_slq <- merge(dats6_slq,seroconvert_complete,by=c("Patient","Time.point"),all.x = T,all.y = F)
dats6_slq$seroconverted <- ifelse(dats6_slq$Diagnosis=="Control",0,dats6_slq$seroconverted)

# fig S7
dats7_iag <- read.csv("./Aaron Michels/Temporal development of T-cell repertoires/Data raw/fig s7a %IAG.csv",na.strings = c(""," ","X"))
...
dats7_iag <- merge(dats7_iag,seroconvert_complete,by=c("Patient","Time.point"),all.x = T,all.y = F)
dats7_iag$seroconverted <- ifelse(dats7_iag$Diagnosis=="Control",0,dats7_iag$seroconverted)

dats7_sag <- read.csv("./Aaron Michels/Temporal development of T-cell repertoires/Data raw/fig s7a S%AG.csv",na.strings = c(""," ","X"))
...
dats7_sag <- merge(dats7_sag,seroconvert_complete,by=c("Patient","Time.point"),all.x = T,all.y = F)
dats7_sag$seroconverted <- ifelse(dats7_sag$Diagnosis=="Control",0,dats7_sag$seroconverted)

dats7_sig <- read.csv("./Aaron Michels/Temporal development of T-cell repertoires/Data raw/fig s7a SI%G.csv",na.strings = c(""," ","X"))
...
dats7_sig <- merge(dats7_sig,seroconvert_complete,by=c("Patient","Time.point"),all.x = T,all.y = F)
dats7_sig$seroconverted <- ifelse(dats7_sig$Diagnosis=="Control",0,dats7_sig$seroconverted)

dats7_sia <- read.csv("./Aaron Michels/Temporal development of T-cell repertoires/Data raw/fig s7a SIA%.csv",na.strings = c(""," ","X"))
...
dats7_sia <- merge(dats7_sia,seroconvert_complete,by=c("Patient","Time.point"),all.x = T,all.y = F)
dats7_sia$seroconverted <- ifelse(dats7_sia$Diagnosis=="Control",0,dats7_sia$seroconverted)
...
dats7_agg <- read.csv("./Aaron Michels/Temporal development of T-cell repertoires/Data raw/fig s7a AGG%.csv",na.strings = c(""," ","X"))
...
dats7_agg <- merge(dats7_agg,seroconvert_complete,by=c("Patient","Time.point"),all.x = T,all.y = F)
dats7_agg$seroconverted <- ifelse(dats7_agg$Diagnosis=="Control",0,dats7_agg$seroconverted)
```
...
## Figure 4a - *AET templates, with interaction of group by time and seroconversion

The p-value for "Time.point:Diagnosis" (i.e., the group by time interaction) in the table of type 3 tests of fixed effects tests whether there was a significant difference in change over time in the two groups.

```{r, echo=FALSE, message=FALSE}
mod <- lme(X..Templates ~ Time.point*Diagnosis + seroconverted,random=~1|Patient,data = dat4a_aet,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point*Diagnosis)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Diagnosis")
...
## Figure 4a - *AET templates, no interaction of group by time, with seroconversion
...
## Figure 4a - *AET templates, cases only, with seroconversion
...
mod <- lme(X..Templates ~ Time.point + seroconverted,random=~1|Patient,data = keep,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
...
## Figure 4a - *AET templates, cases only, without seroconversion
...
## Figure 4a - *AET diversity, with interaction of group by time and seroconversion

The p-value for "Time.point:Diagnosis" (i.e., the group by time interaction) in the table of type 3 tests of fixed effects tests whether there was a significant difference in change over time in the two groups.

```{r, echo=FALSE, message=FALSE}
mod <- lme(X..Unique.CDR3s ~ Time.point*Diagnosis + seroconverted,random=~1|Patient,data = dat4a_aet,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point*Diagnosis)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Diagnosis")
...
## Figure 4a - *AET diversity, no interaction of group by time, with seroconversion
...
## Figure 4a - *AET diversity, cases only, with seroconversion

The p-value for "Time.point" in the table of type 3 tests of fixed effects tests whether there was a significant difference between time points.

```{r, echo=FALSE, message=FALSE}
keep <- dat4a_aet[dat4a_aet$Diagnosis=="Case",]
mod <- lme(X..Unique.CDR3s ~ Time.point + seroconverted ,random=~1|Patient,data = keep,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Time.point")
...
## Figure 4a - *AET diversity, cases only, without seroconversion
...
## Figure 4a - S*ET templates, with interaction of group and time and seroconversion

The p-value for "Time.point:Diagnosis" (i.e., the group by time interaction) in the table of type 3 tests of fixed effects tests whether there was a significant difference in change over time in the two groups.

```{r, echo=FALSE, message=FALSE}
mod <- lme(X..Templates ~ Time.point*Diagnosis + seroconverted,random=~1|Patient,data = dat4a_set,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point*Diagnosis)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Diagnosis")
...
## Figure 4a - S*ET templates, no interaction of group and time, with seroconversion
...
## Figure 4a - S*ET templates, cases only, with seroconversion
...
## Figure 4a - S*ET templates, cases only, without seroconversion
...
## Figure 4a - S*ET diversity, with interaction of group and time and seroconversion

The p-value for "Time.point:Diagnosis" (i.e., the group by time interaction) in the table of type 3 tests of fixed effects tests whether there was a significant difference in change over time in the two groups.

```{r, echo=FALSE, message=FALSE}
mod <- lme(X..Unique.CDR3s ~ Time.point*Diagnosis + seroconverted,random=~1|Patient,data = dat4a_set,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point*Diagnosis)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Diagnosis")
...
## Figure 4a - S*ET diversity, no interaction of group and time, with seroconversion
...
## Figure 4a - S*ET diversity, cases only, with seroconversion
...
## Figure 4a - S*ET diversity, cases only, without seroconversion
...
## Figure 4a - SA*T templates, with interaction of group and time and seroconversion

The p-value for "Time.point:Diagnosis" (i.e., the group by time interaction) in the table of type 3 tests of fixed effects tests whether there was a significant difference in change over time in the two groups.

```{r, echo=FALSE, message=FALSE}
mod <- lme(X..Templates ~ Time.point*Diagnosis + seroconverted,random=~1|Patient,data = dat4a_sat,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point*Diagnosis)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Diagnosis")
...
## Figure 4a - SA*T templates, no interaction of group and time, with seroconversion
...
## Figure 4a - SA*T templates, cases only, with seroconversion
...
## Figure 4a - SA*T templates, cases only, without seroconversion
...
## Figure 4a - SA*T diversity, with interaction of group and time and seroconversion

The p-value for "Time.point:Diagnosis" (i.e., the group by time interaction) in the table of type 3 tests of fixed effects tests whether there was a significant difference in change over time in the two groups.

```{r, echo=FALSE, message=FALSE}
mod <- lme(X..Unique.CDR3s ~ Time.point*Diagnosis + seroconverted,random=~1|Patient,data = dat4a_sat,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point*Diagnosis)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Diagnosis")
...
## Figure 4a - SA*T diversity, no interaction of group and time, with seroconversion
...
## Figure 4a - SA*T diversity, cases only, with seroconversion
...
## Figure 4a - SA*T diversity, cases only, without seroconversion
...
## Figure S6a - S*QS templates, with interaction of group and time and seroconversion

The p-value for "Time.point:Diagnosis" (i.e., the group by time interaction) in the table of type 3 tests of fixed effects tests whether there was a significant difference in change over time in the two groups.

```{r, echo=FALSE, message=FALSE}
mod <- lme(X..Templates ~ Time.point*Diagnosis + seroconverted,random=~1|Patient,data = dats6_sqs,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point*Diagnosis)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Diagnosis")
...
## Figure S6a - S*QS templates, no interaction of group and time, with seroconversion
...
## Figure S6a - S*QS templates, cases only, with seroconversion
...
## Figure S6a - S*QS templates, cases only, without seroconversion
...
## Figure S6a - S*QS diversity, with interaction of group and time and seroconversion

The p-value for "Time.point:Diagnosis" (i.e., the group by time interaction) in the table of type 3 tests of fixed effects tests whether there was a significant difference in change over time in the two groups.

```{r, echo=FALSE, message=FALSE}
mod <- lme(X..Unique.CDR3s ~ Time.point*Diagnosis + seroconverted,random=~1|Patient,data = dats6_sqs,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point*Diagnosis)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Diagnosis")
...
## Figure S6a - S*QS diversity, no interaction of group and time, with seroconversion
...
## Figure S6a - S*QS diversity, cases only, with seroconversion
...
## Figure S6a - S*QS diversity, cases only, without seroconversion
...
## Figure S6a - SL*S templates, with interaction of group and time and seroconversion

The p-value for "Time.point:Diagnosis" (i.e., the group by time interaction) in the table of type 3 tests of fixed effects tests whether there was a significant difference in change over time in the two groups.

```{r, echo=FALSE, message=FALSE}
mod <- lme(X..Templates ~ Time.point*Diagnosis + seroconverted,random=~1|Patient,data = dats6_sls,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point*Diagnosis)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Diagnosis")
...
## Figure S6a - SL*S templates, no interaction of group and time, with seroconversion
...
## Figure S6a - SL*S templates, cases only, with seroconversion
...
## Figure S6a - SL*S templates, cases only, without seroconversion
...
## Figure S6a - SL*S diversity, with interaction of group and time and seroconversion

The p-value for "Time.point:Diagnosis" (i.e., the group by time interaction) in the table of type 3 tests of fixed effects tests whether there was a significant difference in change over time in the two groups.

```{r, echo=FALSE, message=FALSE}
mod <- lme(X..Unique.CDR3s ~ Time.point*Diagnosis + seroconverted,random=~1|Patient,data = dats6_sls,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point*Diagnosis)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Diagnosis")
...
## Figure S6a - SL*S diversity, no interaction of group and time, with seroconversion
...
## Figure S6a - SL*S diversity, cases only, with seroconversion
...
## Figure S6a - SL*S diversity, cases only, without seroconversion
...
## Figure S6a - SLQ* templates, with interaction of group and time and seroconversion

The p-value for "Time.point:Diagnosis" (i.e., the group by time interaction) in the table of type 3 tests of fixed effects tests whether there was a significant difference in change over time in the two groups.

```{r, echo=FALSE, message=FALSE}
mod <- lme(X..Templates ~ Time.point*Diagnosis + seroconverted,random=~1|Patient,data = dats6_slq,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point*Diagnosis)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Diagnosis")
...
## Figure S6a - SLQ* templates, no interaction of group and time, with seroconversion
...
## Figure S6a - SLQ* templates, cases only, with seroconversion
...
## Figure S6a - SLQ* templates, cases only, without seroconversion
...
## Figure S6a - SLQ* diversity, with interaction of group and time and seroconversion

The p-value for "Time.point:Diagnosis" (i.e., the group by time interaction) in the table of type 3 tests of fixed effects tests whether there was a significant difference in change over time in the two groups.

```{r, echo=FALSE, message=FALSE}
mod <- lme(X..Unique.CDR3s ~ Time.point*Diagnosis + seroconverted,random=~1|Patient,data = dats6_slq,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point*Diagnosis)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Diagnosis")
...
## Figure S6a - SLQ* diversity, no interaction of group and time, with seroconversion
...
## Figure S6a - SLQ* diversity, cases only, with seroconversion
...
## Figure S6a - SLQ* diversity, cases only, without seroconversion
...
## Figure S7a - *IAG templates, with interaction of group and time and seroconversion

The p-value for "Time.point:Diagnosis" (i.e., the group by time interaction) in the table of type 3 tests of fixed effects tests whether there was a significant difference in change over time in the two groups.

```{r, echo=FALSE, message=FALSE}
mod <- lme(X..Templates ~ Time.point*Diagnosis + seroconverted,random=~1|Patient,data = dats7_iag,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point*Diagnosis)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Diagnosis")
...
## Figure S7a - *IAG templates, no interaction of group and time, with seroconversion
...
## Figure S7a - *IAG templates, cases only, with seroconversion
...
## Figure S7a - *IAG templates, cases only, without seroconversion
...
## Figure S7a - *IAG diversity, with interaction of group and time, with seroconversion

The p-value for "Time.point:Diagnosis" (i.e., the group by time interaction) in the table of type 3 tests of fixed effects tests whether there was a significant difference in change over time in the two groups.

```{r, echo=FALSE, message=FALSE}
mod <- lme(X..Unique.CDR3s ~ Time.point*Diagnosis + seroconverted,random=~1|Patient,data = dats7_iag,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point*Diagnosis)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Diagnosis")
...
## Figure S7a - *IAG diversity, no interaction of group and time, with seroconversion
...
## Figure S7a - *IAG diversity, cases only, with seroconversion
...
## Figure S7a - *IAG diversity, cases only, without seroconversion
...
## Figure S7a - S*AG templates, with interaction of group and time and seroconversion

The p-value for "Time.point:Diagnosis" (i.e., the group by time interaction) in the table of type 3 tests of fixed effects tests whether there was a significant difference in change over time in the two groups.

```{r, echo=FALSE, message=FALSE}
mod <- lme(X..Templates ~ Time.point*Diagnosis + seroconverted,random=~1|Patient,data = dats7_sag,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point*Diagnosis)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Diagnosis")
...
## Figure S7a - S*AG templates, no interaction of group and time, with seroconversion
...
## Figure S7a - S*AG templates, cases only, with seroconversion
...
## Figure S7a - S*AG templates, cases only, without seroconversion
...
## Figure S7a - S*AG diversity, with interaction of group and time and seroconversion

The p-value for "Time.point:Diagnosis" (i.e., the group by time interaction) in the table of type 3 tests of fixed effects tests whether there was a significant difference in change over time in the two groups.

```{r, echo=FALSE, message=FALSE}
mod <- lme(X..Unique.CDR3s ~ Time.point*Diagnosis + seroconverted,random=~1|Patient,data = dats7_sag,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point*Diagnosis)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Diagnosis")
...
## Figure S7a - S*AG diversity, no interaction of group and time, with seroconversion
...
## Figure S7a - S*AG diversity, cases only, with seroconversion
...
## Figure S7a - S*AG diversity, cases only, without seroconversion
...
## Figure S7a - SI*G templates, with interaction of group and time and seroconversion

The p-value for "Time.point:Diagnosis" (i.e., the group by time interaction) in the table of type 3 tests of fixed effects tests whether there was a significant difference in change over time in the two groups.

```{r, echo=FALSE, message=FALSE}
mod <- lme(X..Templates ~ Time.point*Diagnosis + seroconverted,random=~1|Patient,data = dats7_sig,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point*Diagnosis)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Diagnosis")
...
## Figure S7a - SI*G templates, no interaction of group and time, with seroconversion
...
## Figure S7a - SI*G templates, cases only, with seroconversion
...
## Figure S7a - SI*G templates, cases only, without seroconversion
...
## Figure S7a - SI*G diversity, with interaction of group and time and seroconversion

The p-value for "Time.point:Diagnosis" (i.e., the group by time interaction) in the table of type 3 tests of fixed effects tests whether there was a significant difference in change over time in the two groups.

```{r, echo=FALSE, message=FALSE}
mod <- lme(X..Unique.CDR3s ~ Time.point*Diagnosis + seroconverted,random=~1|Patient,data = dats7_sig,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point*Diagnosis)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Diagnosis")
...
## Figure S7a - SI*G diversity, no interaction of group and time, with seroconversion
...
## Figure S7a - SI*G diversity, cases only, with seroconversion
...
## Figure S7a - SI*G diversity, cases only, without seroconversion
...
## Figure S7a - IAG* diversity, with interaction of group and time and seroconversion
...
## Figure S7a - AGG* templates, with interaction of group and time and seroconversion

The p-value for "Time.point:Diagnosis" (i.e., the group by time interaction) in the table of type 3 tests of fixed effects tests whether there was a significant difference in change over time in the two groups.

```{r, echo=FALSE, message=FALSE}
mod <- lme(X..Templates ~ Time.point*Diagnosis + seroconverted,random=~1|Patient,data = dats7_agg,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point*Diagnosis)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Diagnosis")
...
## Figure S7a - AGG* templates, no interaction of group and time, with seroconversion
...
## Figure S7a - AGG* templates, cases only, with seroconversion
...
## Figure S7a - AGG* templates, cases only, without seroconversion
...
## Figure S7a - AGG* diversity, with interaction of group and time and seroconversion

The p-value for "Time.point:Diagnosis" (i.e., the group by time interaction) in the table of type 3 tests of fixed effects tests whether there was a significant difference in change over time in the two groups.

```{r, echo=FALSE, message=FALSE}
mod <- lme(X..Unique.CDR3s ~ Time.point*Diagnosis + seroconverted,random=~1|Patient,data = dats7_agg,na.action = na.omit)
mod_anova <- anova.lme(mod, type="marginal")
mod_means <- emmeans(mod,~Time.point*Diagnosis)
mod_pairs <-  pairs(mod_means,adjust="tukey",simple="Diagnosis")
...
## Figure S7a - AGG* diversity, no interaction of group and time, with seroconversion
...
## Figure S7a - AGG* diversity, cases only, with seroconversion
...
## Figure S7a - AGG* diversity, cases only, without seroconversion
