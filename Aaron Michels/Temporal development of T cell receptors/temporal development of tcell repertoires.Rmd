...
# fig S7
dats6_iag <- read.csv("T:\\Aaron Michels\\Temporal development of T-cell repertoires\\Data raw\\fig s7a %IAG.csv",na.strings = c(""," ","X"))
dats6_iag$Time.point <- as.factor(dats6_iag$Time.point)
dats6_iag$l.templates <- log(dats6_iag$X..Templates)
dats6_iag$l.unique.CDR3s <- log(dats6_iag$X..Unique.CDR3s)

dats6_sag <- read.csv("T:\\Aaron Michels\\Temporal development of T-cell repertoires\\Data raw\\fig s7a S%AG.csv",na.strings = c(""," ","X"))
dats6_sag$Time.point <- as.factor(dats6_sag$Time.point)
dats6_sag$l.templates <- log(dats6_sag$X..Templates)
dats6_sag$l.unique.CDR3s <- log(dats6_sag$X..Unique.CDR3s)

dats6_sig <- read.csv("T:\\Aaron Michels\\Temporal development of T-cell repertoires\\Data raw\\fig s7a SI%G.csv",na.strings = c(""," ","X"))
dats6_sig$Time.point <- as.factor(dats6_sig$Time.point)
dats6_sig$l.templates <- log(dats6_sig$X..Templates)
dats6_sig$l.unique.CDR3s <- log(dats6_sig$X..Unique.CDR3s)

dats6_sia <- read.csv("T:\\Aaron Michels\\Temporal development of T-cell repertoires\\Data raw\\fig s7a SIA%.csv",na.strings = c(""," ","X"))
dats6_sia$Time.point <- as.factor(dats6_sia$Time.point)
dats6_sia$l.templates <- log(dats6_sia$X..Templates)
dats6_sia$l.unique.CDR3s <- log(dats6_sia$X..Unique.CDR3s)
...
dats6_agg <- read.csv("T:\\Aaron Michels\\Temporal development of T-cell repertoires\\Data raw\\fig s7a AGG%.csv",na.strings = c(""," ","X"))
dats6_agg$Time.point <- as.factor(dats6_agg$Time.point)
dats6_agg$l.templates <- log(dats6_agg$X..Templates)
dats6_agg$l.unique.CDR3s <- log(dats6_agg$X..Unique.CDR3s)
```
