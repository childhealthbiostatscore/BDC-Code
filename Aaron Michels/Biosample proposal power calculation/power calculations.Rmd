...
dat <- read.csv("/Volumes/BDC/Projects/Aaron Michels/Collaborative research using biosamples proposal/sample data for power calculation.csv",
                 na.strings = c("NA"," ","","N/R"))
# below is the basic model we used before
# changes: glmm, also make sure we are testing difference at ANY time point
mod <- lme(log(variable+0.00001) ~ group, random = ~1| Pt..ID, dat,na.action = na.omit)
