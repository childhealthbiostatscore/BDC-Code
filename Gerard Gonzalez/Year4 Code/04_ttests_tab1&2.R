...
t.test(dat$a1c_last_in_year[dat$trt_grp=="LP" & dat$yeargrouping=="Year4"],
       dat$a1c_last_in_year[dat$trt_grp=="Control" & dat$yeargrouping=="Year4"])
#controls
...
t.test(dat$checks_last_in_year[dat$trt_grp=="LP" & dat$yeargrouping=="Year4"],
       dat$checks_last_in_year[dat$trt_grp=="Control" & dat$yeargrouping=="Year4"])
...
t.test(dat.con$a1c_last_in_year[dat.con$group=="Less than 12" & dat.con$yeargrouping=="Year4"],
       dat.con$a1c_last_in_year[dat.con$group=="greater than or equal to 12" & dat.con$yeargrouping=="Year4"])
...
t.test(dat.trt$a1c_last_in_year[dat.trt$group=="Less than 12" & dat.trt$yeargrouping=="Year4"],
       dat.trt$a1c_last_in_year[dat.trt$group=="greater than or equal to 12" & dat.trt$yeargrouping=="Year4"])
...
t.test(dat.con$checks_last_in_year[dat.con$group=="Less than 12" & dat.con$yeargrouping=="Year4"],
       dat.con$checks_last_in_year[dat.con$group=="greater than or equal to 12" & dat.con$yeargrouping=="Year4"])
...
t.test(dat.trt$checks_last_in_year[dat.trt$group=="Less than 12" & dat.trt$yeargrouping=="Year4"],
       dat.trt$checks_last_in_year[dat.trt$group=="greater than or equal to 12" & dat.trt$yeargrouping=="Year4"])
