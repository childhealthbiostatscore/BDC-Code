...
**Table 3a. Differences between LP and Control at each time point**
```{r,echo=FALSE,message=FALSE,results='asis',warning=FALSE}
kable(con_within_yr, align = c("l", "l"))
```

**Table 3b: Differences between timepoints within LPs and controls**
```{r,echo=FALSE,message=FALSE,results='asis',warning=FALSE}
kable(c_across_year, align = c("l", "l"))
```

**Table 3c: Differences between timepoints between LP and control**
```{r,echo=FALSE,message=FALSE,results='asis',warning=FALSE}
kable(c_across_year_grp, align = c("l", "l"))
```
