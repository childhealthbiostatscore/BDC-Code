...
clintab <- CreateTableOne(vars=c("most_recent_ins","most_recent_CGM","visitnum","telenum","per_tele","nsnum","per_ns","cancnum","per_canc",
                                 "med_a1c","med_cgmuse"), data=clinsum, strata="group", test=TRUE)
clintab <- print(clintab,varLabels=TRUE,showAllLevels=TRUE,nonnorm=c("med_a1c","visitnum","telenum","per_tele","nsnum","per_ns","cancnum","per_canc","med_cgmuse"),
                 minMax=T)

# Clinical and visit table by high/low telemedicine use
clintaba <- CreateTableOne(vars=c("most_recent_ins","most_recent_CGM","visitnum","telenum","per_tele","nsnum","per_ns","cancnum","per_canc",
                                 "med_a1c","med_cgmuse"), data=clinsum, strata="telegroup", test=TRUE)
clintaba <- print(clintaba,varLabels=TRUE,showAllLevels=TRUE,nonnorm=c("med_a1c","visitnum","telenum","per_tele","nsnum","per_ns","cancnum","per_canc","med_cgmuse"),
                  minMax=T)
...
```{r, echo=FALSE, message=FALSE}
kable(mod_perns.anova,caption="Table 6a.  No-show percent - test of interaction between high/low telemedicine use and group.  The right-most column contains the p-value; the telegroup:group term is the interaction effect.",format.args = list(scientific = FALSE))
```

```{r, echo=FALSE, message=FALSE}
kable(mod_perns_means,caption="Table 6b.  No-show percent - group means.",format.args = list(scientific = FALSE))
```

\newpage

```{r, echo=FALSE, message=FALSE}
kable(mod_perns_pairs,caption="Table 6c.  No-show percent - pairwise comparisons of group means.",format.args = list(scientific = FALSE))
```
...
```{r, echo=FALSE, message=FALSE}
kable(mod_cancnum.anova,caption="Table 7.  Cancellation number - test of interaction between high/low telemedicine use and group.  The right-most column contains the p-value; the telegroup:group term is the interaction effect.",format.args = list(scientific = FALSE))
```

```{r, echo=FALSE, message=FALSE}
kable(mod_percanc.anova,caption="Table 8.  Percent cancellation - test of interaction between high/low telemedicine use and group.  The right-most column contains the p-value; the telegroup:group term is the interaction effect.",format.args = list(scientific = FALSE))
```

```{r, echo=FALSE, message=FALSE}
kable(mod_medcgm.anova,caption="Table 9.  Median % CGM use - test of interaction between high/low telemedicine use and group.  The right-most column contains the p-value; the telegroup:group term is the interaction effect.",format.args = list(scientific = FALSE))
```

\newpage

```{r, echo=FALSE, message=FALSE}
kable(mod_meda1c.anova,caption="Table 10.  Median A1c - test of interaction between high/low telemedicine use and group.  The right-most column contains the p-value; the telegroup:group term is the interaction effect.",format.args = list(scientific = FALSE))
```
