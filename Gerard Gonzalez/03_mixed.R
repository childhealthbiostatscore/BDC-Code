...
a1c_mod1<-lme(a1c_last_in_year~baseline_a1c+factor(yeargrouping)+factor(group)+factor(trt_grp)+factor(yeargrouping)*factor(trt_grp)+
                duration_of_diagnosis,random=~1|MRN,data=dat)
summary(a1c_mod1)
coef(a1c_mod1)
