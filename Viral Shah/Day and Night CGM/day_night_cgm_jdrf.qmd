...
```{r results='asis'}
columns <- make.names(c("jdrf","a1c", "Age", "Gender", "BMI", "Race_Ethnicity", "DiabetesDuration_MostRecentVisitDate", "Hemoglobin_Value", "MCV_Value", "eGFR_Value", "Autoimmune Disease?", "Retinopathy?", "mdi"))
