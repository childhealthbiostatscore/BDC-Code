...
cat("\n")
cat(paste("Multiple Correlation Coefficient = ",fsbg_adj_mod$r.squared))
cat("\n")
```
...
cat("\n")
cat(paste("Multiple Correlation Coefficient = ",a1c_adj_mod$r.squared))
cat("\n")
```
...
cat("\n")
cat(paste("Multiple Correlation Coefficient = ",tir_adj_mod$r.squared))
cat("\n")
```
...
cat("\n")
cat(paste("Multiple Correlation Coefficient = ",tar_adj_mod$r.squared))
cat("\n")
```
## Demographics Table
