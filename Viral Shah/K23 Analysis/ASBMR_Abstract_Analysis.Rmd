...
cgm_summary = cgm_summary %>% mutate(record_id = gsub("(\\w$)", "\\U\\1", ID, perl = TRUE))
...
* weak linear relationship between 14 day mean and p1np and ctx (r = 0.29, 0.14 respectively)
...
* very weak linear relationship between 14 day mean and p1np and ctx (r = 0.14, -0.04 respectively)
...
* weak linear relationship between 14 day mean and p1np and ctx (r = -0.29, -0.16 respectively)
...
* weak linear relationship between 14 day mean and p1np and ctx (r = -0.37, -0.20 respectively)
...
* weak linear relationship between 14 day mean and p1np and ctx (r = 0.34, 0.20 respectively)

```{r tirgt180}
# correlations
analysis$`14 Day TIR Over 180`
