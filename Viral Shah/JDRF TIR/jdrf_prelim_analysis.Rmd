...
lab_table_df = lab_table_df %>% ungroup() %>% select(-c(`Study ID`, yrs_since_ret))
...
a1c_YEAR_p + geom_line() + 
  ...
  labs(x ="Years to Retinopathy Diagnosis", y = "A1c (%)")+ xlim(5,1)
...
tir_YEAR_p + geom_line()+ 
  ...
  labs(x ="Years to Retinopathy Diagnosis", y = "TIR (%)")+ xlim(5,1)
