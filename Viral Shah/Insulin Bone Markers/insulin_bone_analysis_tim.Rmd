...
# By gender
t1c <- CreateTableOne(t1vars[-c(which(t1vars == "Gender"))],strata = "Gender",data = alldata)
t1c <- as.data.frame(print(t1c,nonnormal = nonnormvars,exact = catvars))
```
...
```{r echo=FALSE}
kable(t1c, caption = "Descriptive statistics at baseline by gender")
```
