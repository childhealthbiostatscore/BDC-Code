...
## Percent Change ANOVA Residuals

### P1NP

```{r echo=FALSE}
p1np.aov <- aov(perc_change_P1NP ~ group, data = full_data)
plot(p1np.aov)
```
...
```{r echo=FALSE}
ctx1.aov <- aov(perc_change_CTX1 ~ group, data = full_data)
plot(ctx1.aov)
```
...
```{r echo=FALSE}
oc.aov <- aov(perc_change_Osteocalcin ~ group, data = full_data)
plot(oc.aov)
```
...
```{r echo=FALSE}
on.aov <- aov(perc_change_ON ~ group, data = full_data)
plot(on.aov)
```
...
```{r echo=FALSE}
opg.aov <- aov(perc_change_OPG ~ group, data = full_data)
plot(opg.aov)
```
...
```{r echo=FALSE}
igf.aov <- aov(perc_change_IGF ~ group, data = full_data)
plot(igf.aov)
```
