...
# Old data
old <- read.csv(paste0(pathstart,"som/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Viral Shah/Insulin bone marker/Abstract/Data_Cleaned/updated_full_data_bone_turnover.csv"))
# Viral's data
