...
# really want to use the variable called "age_wrong" - the "age" variable was calculated at an unknown timepoint
data$Age <- NULL
data$Age <- data$Age_wrong
...
t1d$Diagnosis_Age_lt20 <- ifelse(t1d$Diagnosis_Age<20,1,0)
...
## Models comparing those diagnosed age <20 vs. >=20, adjusted for age, sex, BMI, and NN BMD - NN variables, T1D only
...
# group comparisons adjusted for age, sex, BMI
for (v in NN_vars) {
  form = as.formula(paste0(v,"~Diagnosis_Age_lt20+Age+as.factor(Sex)+BMI + NN_BMD"))
...
## Models comparing those diagnosed age <20 vs. >=20, adjusted for age, sex, BMI, and FS BMD - FS variables, T1D only
...
# group comparisons adjusted for age, sex, BMI
for (v in FS_vars) {
  form = as.formula(paste0(v,"~Diagnosis_Age_lt20+Age+as.factor(Sex)+BMI + FS_BMD"))
  mod <- lm(form,data = t1d)
  print(noquote(c("Adjusted model for: ", noquote(v))))
  print(summary(mod))
  means <- emmeans(mod,"Diagnosis_Age_lt20")
...
## Models comparing those diagnosed age <20 vs. >=20, adjusted for age, sex, BMI, and IT BMD - IT variables, T1D only
...
# group comparisons adjusted for age, sex, BMI
for (v in IT_vars) {
  form = as.formula(paste0(v,"~Diagnosis_Age_lt20+Age+as.factor(Sex)+BMI + IT_BMD"))
  mod <- lm(form,data = t1d)
  print(noquote(c("Adjusted model for: ", noquote(v))))
  print(summary(mod))
  means <- emmeans(mod,"Diagnosis_Age_lt20")
...
# group comparisons adjusted for age, sex, BMI
for (v in NN_vars) {
  form = as.formula(paste0(v,"~yrs_since_dx+as.factor(Sex)+BMI + NN_BMD"))
  mod <- lm(form,data = t1d)
  print(noquote(c("Adjusted model for: ", noquote(v))))
  print(summary(mod))
  #means <- emmeans(mod,"Diagnosis_Age_lt20")
...
# group comparisons adjusted for age, sex, BMI
for (v in FS_vars) {
  form = as.formula(paste0(v,"~yrs_since_dx+as.factor(Sex)+BMI + FS_BMD"))
  mod <- lm(form,data = t1d)
  print(noquote(c("Adjusted model for: ", noquote(v))))
  print(summary(mod))
  #means <- emmeans(mod,"Diagnosis_Age_lt20")
...
# group comparisons adjusted for age, sex, BMI
for (v in IT_vars) {
  form = as.formula(paste0(v,"~yrs_since_dx+as.factor(Sex)+BMI + IT_BMD"))
  mod <- lm(form,data = t1d)
  print(noquote(c("Adjusted model for: ", noquote(v))))
  print(summary(mod))
 # means <- emmeans(mod,"Diagnosis_Age_lt20")
