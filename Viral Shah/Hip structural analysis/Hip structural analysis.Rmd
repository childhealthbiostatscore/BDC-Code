...
# group comparisons adjusted for age, sex, BMI
for (v in NN_vars) {
  form = as.formula(paste0(v,"~Diagnosis_Age_lt20+as.factor(Sex)+BMI "))
...
# group comparisons adjusted for age, sex, BMI
for (v in NN_vars) {
  form = as.formula(paste0(v,"~Diagnosis_Age_lt20+as.factor(Sex)+BMI + NN_BMD"))
  mod <- lm(form,data = t1d)
  print(noquote(c("Adjusted model for: ", noquote(v))))
  print(summary(mod))
  means <- emmeans(mod,"Diagnosis_Age_lt20")
...
# group comparisons adjusted for age, sex, BMI
for (v in FS_vars) {
  form = as.formula(paste0(v,"~Diagnosis_Age_lt20+as.factor(Sex)+BMI + FS_BMD"))
  mod <- lm(form,data = t1d)
  print(noquote(c("Adjusted model for: ", noquote(v))))
  print(summary(mod))
  means <- emmeans(mod,"Diagnosis_Age_lt20")
...
# group comparisons adjusted for age, sex, BMI
for (v in IT_vars) {
  form = as.formula(paste0(v,"~Diagnosis_Age_lt20+as.factor(Sex)+BMI + IT_BMD"))
  mod <- lm(form,data = t1d)
  print(noquote(c("Adjusted model for: ", noquote(v))))
  print(summary(mod))
  means <- emmeans(mod,"Diagnosis_Age_lt20")
