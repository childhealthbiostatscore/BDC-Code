...
```{r echo=FALSE,comment=''}
std %>% ggplot(aes(x=T1DStatus,y=s.NN_CSA,fill=T1DStatus)) + geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent")
std %>% ggplot(aes(x=T1DStatus,y=s.IT_CSA,fill=T1DStatus)) + geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent")
std %>% ggplot(aes(x=T1DStatus,y=s.FS_CSA,fill=T1DStatus)) + geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent")

std %>% ggplot(aes(x=T1DStatus,y=s.NN_CSMI,fill=T1DStatus)) + geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent")
std %>% ggplot(aes(x=T1DStatus,y=s.IT_CSMI,fill=T1DStatus)) + geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent")
std %>% ggplot(aes(x=T1DStatus,y=s.FS_CSMI,fill=T1DStatus)) + geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent")

std %>% ggplot(aes(x=T1DStatus,y=s.NN_ED,fill=T1DStatus)) + geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent")
std %>% ggplot(aes(x=T1DStatus,y=s.IT_ED,fill=T1DStatus)) + geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent")
std %>% ggplot(aes(x=T1DStatus,y=s.FS_ED,fill=T1DStatus)) + geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent")

std %>% ggplot(aes(x=T1DStatus,y=s.NN_ACT,fill=T1DStatus)) + geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent")
std %>% ggplot(aes(x=T1DStatus,y=s.IT_ACT,fill=T1DStatus)) + geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent")
std %>% ggplot(aes(x=T1DStatus,y=s.FS_ACT,fill=T1DStatus)) + geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent")

std %>% ggplot(aes(x=T1DStatus,y=s.NN_PCD,fill=T1DStatus)) + geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent")
std %>% ggplot(aes(x=T1DStatus,y=s.IT_PCD,fill=T1DStatus)) + geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent")
std %>% ggplot(aes(x=T1DStatus,y=s.FS_PCD,fill=T1DStatus)) + geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent")

std %>% ggplot(aes(x=T1DStatus,y=s.NN_BR,fill=T1DStatus)) + geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent")
std %>% ggplot(aes(x=T1DStatus,y=s.IT_BR,fill=T1DStatus)) + geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent")
std %>% ggplot(aes(x=T1DStatus,y=s.FS_BR,fill=T1DStatus)) + geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent")
```