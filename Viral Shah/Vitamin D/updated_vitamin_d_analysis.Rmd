...
full_results <- as.data.frame(summary(total_mod_full)$coefficients)
# Interaction
interact_mod_red <- lm(total.vd ~ vdbp * abgroup ,data = dat)
...
full_results <- as.data.frame(summary(free_mod_full)$coefficients)
# Interaction
interact_mod_red <- lm(free.vd ~ vdbp * abgroup ,data = dat)
