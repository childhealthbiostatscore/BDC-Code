...
alldata <- read.csv("S:\\Shared Projects\\Laura\\BDC\\Projects\\Viral Shah\\TIR and A1c in pregnancy\\Data Cleaned\\for_viral.csv")
alldata <- alldata[!is.na(alldata$trimester),]

# read in SMBG data
source("S:\\Shared Projects\\Laura\\BDC\\Projects\\Viral Shah\\TIR and A1c in pregnancy\\Data Raw\\PregnancyCGM-SMBG_R_2020-02-28_1912.r")
...
taboutvars <- c("a1c_trimester_mean","per_in_range_63_140","percent_time_over_140", "percent_time_under_63",
                "gmi","estimated_a1c","smbg_tir_mean","smbg_tbr_mean","smbg_tar_mean")
