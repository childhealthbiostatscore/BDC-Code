...
# get gestational age at 1st pregnancy visit
preg1 <- alldata[alldata$visit==1,c("subject_id","gest_wk","gest_d")]
preg1$d7 <- preg1$gest_d/7
preg1$gest1 <- rowSums(preg1[,c("gest_wk","d7")])
demo <- merge(demo,preg1,by="subject_id",all.x=T,all.y=F)
