...
dclp3_cgm = dclp3_cgm[dclp3_cgm['analysis'] == '1. 24hr']
dclp3_cgm['period'].replace({'1. Baseline':'Randomization','2. Post Randomization':'26 Week'},inplace=True)
dclp3_cgm = dclp3_cgm[['PtID','period','gluMean']]
...
dclp3_a1c = dclp3_a1c[(dclp3_a1c['Visit'] == 'Randomization') | (dclp3_a1c['Visit'] == '26 Week')]
dclp3_a1c = dclp3_a1c[['PtID','Visit','Value']]
dclp3_a1c.columns = ['PtID','period','HbA1c']
# Merge and clean up
...
#| code-fold: true
# Pedicted values
newdat = data.frame(Mean.Glucose = seq(from = min(df$Mean.Glucose),to = max(df$Mean.Glucose),length.out = 100))
