...
##Summary Tables:
table1<-final_table(dat,c('Age','Gender','Years.w.Diabetes','weight_mean',
                          'basal_mean','bolus_mean','active_mean','carb_ratio_mean'),
...
##Outcome Tables:
#outcome 1 (A1C)
table_a1c<-final_table(dat,c('A1C_3mo_pre','A1C_6mo_post','a1c_mean','a1c_change'),
                  dat$Group,margin=2,single=F,2, col.names=T, summary.stat='median')
table_a1c
