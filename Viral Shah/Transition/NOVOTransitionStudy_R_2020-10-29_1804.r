#Read Data
data=read.csv('./Data_Raw/NOVOTransitionStudy_DATA_2020-10-29_1804.csv')
#Setting Labels
...
levels(data$diab_conditions___1.factor)=c("Unchecked","Checked")
levels(data$diab_conditions___2.factor)=c("Unchecked","Checked")
levels(data$diab_conditions___3.factor)=c("Unchecked","Checked")
levels(data$diab_conditions___4.factor)=c("Unchecked","Checked")
levels(data$diab_conditions___5.factor)=c("Unchecked","Checked")
