...
ggplot(cgm_data,aes(x = factor(randomization_group),y = percent_time_70_180.x)) + 
  geom_boxplot() + theme_bw() +
  xlab("Group") + ylab("% TIR") + ggtitle("Randomization Period")

ggplot(cgm_data,aes(x = factor(randomization_group),y = percent_time_70_180.y)) + 
  geom_boxplot() + theme_bw() +
  xlab("Group") + ylab("% TIR") +ggtitle("First 72 Hours")
```