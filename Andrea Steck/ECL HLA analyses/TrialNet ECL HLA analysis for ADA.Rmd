...
# read in data
data <- read.csv("S:\\Shared Projects\\Laura\\BDC\\Projects\\Andrea Steck\\ECL ab and genotype\\Data\\191015 final dataset 1287 subjects with genotype_update tt aks.csv",
                 na.strings = c("NA",""," "))
keep <- data
