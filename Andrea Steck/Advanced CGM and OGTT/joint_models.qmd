...
setwd(home_dir)
# Load results
load("./Data_Clean/joint_model_results_all.RData")
```
...
```{r}
traceplot(joint_fit_mean, "betas")
...
```{r}
traceplot(joint_fit_mean_sd, "betas")
...
```{r}
traceplot(joint_fit_hba1c, "betas")
