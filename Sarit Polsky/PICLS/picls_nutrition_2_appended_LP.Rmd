...
# file 18-1798 Nutrient Analysis Export Post-Partum has PP for 107A, 108A which does not appear to be in dataset, but is also not marked missing
...
extra6 <- extra6 %>% filter(`Participant/Menu ID` %in% c("107A", "108A"))
a <- colnames(extra6)
...
ctrc2 = ctrc2 %>% unique()
# by this point, PP for 107A and 211B are missing
