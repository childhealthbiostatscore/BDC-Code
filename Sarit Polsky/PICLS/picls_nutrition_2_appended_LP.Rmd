...
#data upload
Final_Baseline <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/CTRC files/18-1798 Nutrient Analysis Export/18-1798 Final Baseline.xlsx")
more_baseline <-  read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/CTRC files/18-1798 Nutrient Analysis Export/NDS export archive/18-1798 Nutrient Analysis Export Baseline.xlsx")
...
Final_2Tri <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/CTRC files/18-1798 Nutrient Analysis Export/18-1798 Final 2nd trimester.xlsx")
Final_3Tri <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/CTRC files/18-1798 Nutrient Analysis Export/18-1798 Final 3rd Trimester.xlsx")
Final_PP <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/CTRC files/18-1798 Nutrient Analysis Export/18-1798 Final Postpartum.xlsx")

mp_meal <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/CTRC files/18-1798 Nutrient Analysis Export/18-1798 Missing Participants Export.xlsx", 
    sheet = "Meal Totals")
mp_daily <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/CTRC files/18-1798 Nutrient Analysis Export/18-1798 Missing Participants Export.xlsx", 
    sheet = "Daily Totals")
...
# extra1 <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/CTRC files/18-1798 Nutrient Analysis Export/NDS export archive/18-1798 Nutrient Analysis Export 1st Trimester.xlsx")
# a <- colnames(extra1)
...
extra2 <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/CTRC files/18-1798 Nutrient Analysis Export/NDS export archive/18-1798 Nutrient Analysis Export 2nd Trimester 9.10.2020.xlsx")

# 2nd trimester 100A
extra3 <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/CTRC files/18-1798 Nutrient Analysis Export/NDS export archive/18-1798 Nutrient Analysis Export 2nd Trimester.xlsx")
a <- colnames(extra3)
...
# 3rd trimester 108A
# per Scott, do not include this file
# extra4 <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/CTRC files/18-1798 Nutrient Analysis Export/NDS export archive/18-1798 Nutrient Analysis Export 3rd Trimester.xlsx")
# a <- colnames(extra4)
...
extra5 <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/CTRC files/18-1798 Nutrient Analysis Export/NDS export archive/18-1798 Nutrient Analysis Export Baseline.xlsx")
...
names(b) <- c("varname", "in_final_baseline")
ab <- full_join(a, b, by = "varname")
write_csv(ab,"/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/mismatch_colnames.csv")
...
extra6 <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/CTRC files/18-1798 Nutrient Analysis Export/NDS export archive/18-1798 Nutrient Analysis Export Post-Partum.xlsx")
...
extra6a <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/CTRC files/18-1798 Nutrient Analysis Export/NDS export archive/18-1798 Nutrient Analysis Export Post-Partum.xlsx")
...
extra7 <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/CTRC files/18-1798 Nutrient Analysis Export/119-A Missing Days.xlsx")
a <- colnames(extra7)
...
corrected <- read_excel('/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/CTRC files/18-1798 Nutrient Analysis Export/18-1798 11.22.2024 Export.xlsx')
...
PICLS <- read_csv("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/PICLSStudyHCLVsSAPTI_DATA_2024-05-24_1006(1).csv")
# groups and gest dates and centiles
gestdates <- read_csv("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS/Data cleaning/CGM Data Check_6.8.23.csv") 
groups <- read.csv("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS/Data_Clean/PICLSStudyHCLVsSAPTI-RandomizedPatients_DATA_2022-11-14_1616.csv")%>% select(pid, randomization_group)
groups$randomization_group = factor(groups$randomization_group, levels = c(1,2), labels = c("HCL","SAPT") )

centiles = read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS/Data_Clean/BulkCentileCalc_Global_v8.0.6.1_PICLS_v5_CJ.xlsm", 
...
write.csv(maternal_diet_subj_day, "/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/Data_clean/maternal_diet_subj_day.csv", row.names = F)
...
cleanedcgm_noacet <- read_csv("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS/Data_Raw/cleanedcgm_noacet.csv")
...
Preg_visits <- read_csv("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS/Data_Clean/QPregnancyVisits_DATA_2022-12-04_1234.csv")
...
write_csv(last_weights_tri, "/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/Data_clean/last_weights_tri.csv")
...
analysis_m1 = analysis_aim1_tri %>% ungroup() %>% group_by(pid) %>% select(avg_daily_fiber_g_s:avg_daily_plant_perc_s, avg_weekly_weight_gain_lbs, avg_daily_mufa_pufa_calperc) %>% 
  summarise(fiber_s = mean(avg_daily_fiber_g_s),
            ...
            mufa_pufa_calperc = mean(avg_daily_mufa_pufa_calperc),
...
write.csv(pp_weights, "/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sarit Polsky/PICLS 3 NUTRITION LOGS/Data_clean/pp_weights.csv")
```
...
### Correlation of saturated fat and animal protein

```{r}
cor.test(analysis_m1$s_satfat_calperc, analysis_m1$animal_perc_s)
```

### Correlation of MUFA/PUFA and saturated fat

```{r}
cor.test(analysis_m1$mufa_pufa_calperc, analysis_m1$s_satfat_calperc)
```
...
```{r}
#fit_lr_mod("avg_daily_satfat_g_s", analysis_m1_tri, F)
mod = glm(excessive_weight_gain ~ mufa_pufa_calperc + bmi_baseline, data = analysis_m1, family = "binomial")
anova(mod)
mod <- tidy(mod, exponentiate = TRUE)
mod
```
...
```{r}
fit_mod("mufa_pufa_calperc + bmi_baseline", analysis_m1)
```
...
```{r}
#fit_lr_mod("avg_daily_satfat_g_s", analysis_m1_tri, F)
mod = glm(excessive_weight_gain ~ mufa_pufa_calperc, data = analysis_m1, family = "binomial")
anova(mod)
mod <- tidy(mod, exponentiate = TRUE)
mod
```
...
```{r}
fit_mod("mufa_pufa_calperc", analysis_m1)
```
