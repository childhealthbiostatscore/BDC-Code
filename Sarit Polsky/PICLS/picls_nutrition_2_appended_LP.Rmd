...
more_baseline <- more_baseline %>% filter(`Participant/Menu ID` %in% c("102A", "106A"))
...
Subjects maternal weight gain was measured using the last pregnancy visit compared with the preconception weight. This was then averaged into a weekly weight gain over gestation. Excessive weight gain(either by weekly weight gain or total weight gain) was derived for the entire pregnancy.

Grams of fiber was standardized as (FiberTotal)*2000/Cal_Total
