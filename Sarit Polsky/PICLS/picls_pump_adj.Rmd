...
list_of_pumpdfs <- lapply(as.list(pump_files_list), function(x) read_xlsx(x, sheet = 2, col_types = c("text", "date", "time", "numeric", "numeric", "numeric", "numeric", "numeric")))
...
# "Basal units/hour","Carb ratio (g/U)","Correction bolus"
