...
1) Added the run-in time point for CGM data.

2) Removed CGM data 8 hours after acetaminophen, or removed all data from the day of acetaminophen if the time was missing.

3) Added new CGM variables (J-index, HBGI, LBGI, MAGE, CONGA_1)
