...
standardized_groups = maternal_diet_subj_day %>% group_by(pid, tp) %>% select(pid, tp, randomization_group, Cal_Total, FiberTotal,
  ...
  mutate(s_fiber = (2*FiberTotal)*2000/Cal_Total,
         s_carb = (4*CarbTotal)*2000/Cal_Total,
         s_fat = (9*FatTotal)*2000/Cal_Total,
         s_sfat = (9*Sfa_total)*2000/Cal_Total,
         s_protein = (4*ProteinTotal)*2000/Cal_Total,
