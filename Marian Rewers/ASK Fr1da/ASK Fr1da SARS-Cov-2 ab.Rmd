...
ask_data <- read.csv("B:\\Projects\\Marian Rewers\\ASK\\ASK Fr1da\\Data raw\\ASK for Laura May 23 CalendarTime and Vaccinated.csv",na.strings = c("NA",""," "))
...
fr1da_data <- read.csv("B:\\Projects\\Marian Rewers\\ASK\\ASK Fr1da\\Data raw\\Fr1da for Laura May 23 CalendarTime LP.csv",na.strings = c("NA",""," "))
...
# ANALYSES STRATIFIED BY FAMILY HISTORY
