...
ask_data <- read.csv("B:\\Projects\\Marian Rewers\\ASK\\ASK Fr1da\\Data raw\\ASK dataset for Laura Feb 22 with TGA limited.csv",na.strings = c("NA",""," "))
...
tga_mod_adj <- glm(data=ask_data, TGA_01 ~ COVID_Infection2_01 + AgeAtScreen + Sex + T1D_Fam + RaceEthnicity_2group, family="binomial")
