...
```{r alarm plot,echo=FALSE,warning=FALSE}
...
```{r tir plot, echo=FALSE,warning=FALSE}
tir_over_time <- 
...
## Nighttime % Time < 70 by Timepoint

```{r under 70 plot, echo=FALSE,warning=FALSE}
under_70_over_time <- 
  ggplot(overnight_alarms,aes(x = timepoint, y = percent_time_under_70_night,group = id)) + 
  geom_line() + theme_bw() + xlab("Timepoint") + ylab("% Time <70")
under_70_over_time
```
