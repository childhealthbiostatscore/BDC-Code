...
# Random slope
mod_ri_rs <- glmmPQL(num_alarms ~ timepoint + perc_time_in_AM,random = ~timepoint|id,
               data = overnight_alarms,family = "poisson")
# AR(1) correlation structure
# Random intercept
mod_ri_ar1 <- glmmPQL(num_alarms ~ timepoint + perc_time_in_AM,random = ~1|id,
               data = overnight_alarms,family = "poisson",correlation = corCAR1())
# Random slope
mod_ri_rs_ar1 <- glmmPQL(num_alarms ~ timepoint + perc_time_in_AM,random = ~timepoint|id,
               data = overnight_alarms,family = "poisson",correlation = corCAR1())
```
