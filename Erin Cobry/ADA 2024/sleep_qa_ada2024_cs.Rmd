...
# demog covariates
demog_df = sd_df %>% select(record_id, redcap_event_name,gender_m_fo ,age, age_cat,race ,parenteducation, diabetesduration, insulinmethod, currenthcltech, current_cgm_use, rurality) %>% 
...
analysis = sd_df %>% select(record_id,redcap_event_name,
                            ...
                            sensor_70_180, sensor_181_250, sensor_g251, sensor_u54, sensor_55_69,sensor_mean # diab meas
