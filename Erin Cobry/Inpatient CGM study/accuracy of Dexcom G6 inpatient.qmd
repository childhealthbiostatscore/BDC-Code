...
source("B:/Projects/Erin Cobry/Inpatient CGM study/Data raw/AccuracyOfTheDexcomG-PatientInfoAndLocati_R_2022-12-08_1319.r")
patient <- data
...
newclarityfiles <- base::list.files(path = "B:/Projects/Erin Cobry/Inpatient CGM study/Data raw/Dexcom CSVs",full.names = TRUE,recursive = T)
...
glucose_keep$AKI <- ifelse(glucose_keep$record_id %in% c("052","053","064","082","083","089"),"AKI","No AKI")
