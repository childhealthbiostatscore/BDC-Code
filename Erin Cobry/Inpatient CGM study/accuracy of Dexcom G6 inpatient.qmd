...
#newclarityfiles <- base::list.files(path = "C:/Temp/csvtest",full.names = TRUE,recursive = T)

#for (f in 53:length(newclarityfiles)) {
...
# bug in this step....can't link the record IDs in glucose_keep and cgm_keep
