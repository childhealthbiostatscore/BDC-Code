...
# per Erin, keep only the lab values for now
glucose <- glucose %>% filter(bgtype==3)
...
-   Hospital glucose values were imported from REDCap. For this analysis, only lab glucose values were included.
