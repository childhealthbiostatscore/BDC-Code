...
tele$dob <- as.Date(tele$dod, format="%m/%d/%Y")
tele <- tele %>% mutate(Age_12132019 = as.numeric(as.Date("2019-12-13") - dob) / 365.25)
...
combclinic <- allclinic[,c("techgroup","LastA1C_OrderValue","Distance.to.Clinic.Driving..Km.","Distance.to.Clinic.Direct..Km.",
                           "Rural","InsuranceType","Age_12132019","Gender")]
...
techtable <- CreateTableOne(vars=c("techgroup","anypump","anycgm","pumponly","cgmonly","pump_cgm","tech",
                                   ...
                                   "Distance.to.clinic.direct..KM...as.the.crow.flies.","Rural.","Age_12132019","Gender" ), 
