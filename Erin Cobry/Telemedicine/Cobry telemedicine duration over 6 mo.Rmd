...
techtable <- CreateTableOne(vars=c("techgroup","anypump","anycgm","pumponly","cgmonly","pump_cgm",
...
tele$tech <- NA
tele[(!is.na(tele$cgm) & tele$cgm==1) | (!is.na(tele$pump) & tele$pump==1) | (!is.na(tele$pump_cgm) & tele$pump_cgm==1),]$tech <- "Uses tech"
tele[(!is.na(tele$cgm) & tele$cgm==0) & (!is.na(tele$pump) & tele$pump==0) & (!is.na(tele$pump_cgm) & tele$pump_cgm==0),]$tech <- "Doesn't use tech"
tele[is.na(tele$cgm) | is.na(tele$pump) | is.na(tele$pump_cgm),] <- NA
