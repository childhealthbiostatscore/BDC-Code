...
# promis tables
Depression_T <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/JDRF Career Development Grant/Phase 1 Manuscript/Data_raw/Depression T-tables.xlsx", 
...
pp_dep_short = read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Depression T-tables.xlsx", 
                          sheet = "Parent Proxy Depressive Sx 6a")
pp_dep_short$parent_depression_t <- pp_dep_short$`T-score`

Anxiety_T <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/JDRF Career Development Grant/Phase 1 Manuscript/Data_raw/Anxiety T-tables.xlsx", 
...
pp_anx_short = read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Anxiety T-tables.xlsx", 
                          sheet = "Parent Proxy Anxiety 8a")
pp_anx_short$parent_anxiety_t <- pp_anx_short$`T-Score`

Psychological_Stress_T <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/JDRF Career Development Grant/Phase 1 Manuscript/Data_raw/Psychological Stress Experience T-tables.xlsx", 
...
pp_pse_short = read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Psychological Stress Experience T-tables.xlsx", 
                             sheet = "Parent Proxy Psy Stress Exp 4a")
pp_pse_short$parent_psych_stress_t <- pp_pse_short$`T-score`

Sleep_Disturbance_T <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/JDRF Career Development Grant/Phase 1 Manuscript/Data_raw/Sleep Disturbance and Sleep Related Impairment T Tables.xlsx", 
...
Impairment_T <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/JDRF Career Development Grant/Phase 1 Manuscript/Data_raw/Sleep Disturbance and Sleep Related Impairment T Tables.xlsx", 
...
peds_lifesatisfaction_short <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Life Satisfaction T-tables.xlsx", 
...
peds_physact_short <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Physical Activity T-tables.xlsx", 
                                          sheet = "Pediatric Physical Activity 4a")
peds_physact_short$child_physact_t <- peds_physact_short$`T-score`
pp_physact_short = read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Physical Activity T-tables.xlsx", 
...
peds_posaff_short <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Positive Affect T-tables.xlsx", 
                                 sheet = "Pediatric Positive Affect 4a")
peds_posaff_short$child_posaff_t <- peds_posaff_short$`T-score`
pp_posaff_short = read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Positive Affect T-tables.xlsx", 
...
peds_anger_short <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Anger T-tables.xlsx", 
                            sheet = "Pediatric Self Report 5a")
peds_anger_short$child_anger_t <- peds_anger_short$`T-Score`
pp_anger_short = read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Anger T-tables.xlsx", 
...
peds_fr_short <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Relationships T-tables.xlsx", 
                            sheet = "Pediatric Family Relation 8a")
peds_fr_short$child_fr_t <- peds_fr_short$`T-score`
pp_fr_short = read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Relationships T-tables.xlsx", 
...
peds_pr_short <- read_excel("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Relationships T-tables.xlsx", 
...
# data upload
sd_df = read_csv("/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/JDRF Career Development Grant/Phase 1 Manuscript/Data_raw/SleepDisruptorsInAdo_DATA_2024-10-30_0826.csv")
...
# Score PROMIS
source("/Users/lpyle/Documents/GitHub/BDC-Code/Erin Cobry/JDRF Phase 1 manuscript/promis-scoring-r.r")
...
# add scaled scores
source("/Users/lpyle/Documents/GitHub/BDC-Code/Erin Cobry/JDRF Phase 1 manuscript/promis scaled scores v3.r")
...
p_fam <- read.csv('/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/JDRF Career Development Grant/Phase 1 Manuscript/Data_raw/SleepDisruptorsInAdo-PROMISParentFamRelat_DATA_2025-03-18_0745.csv')
...
# merge sufficient sleep var back to demog
sufficient_sleep_df <- analysis %>% select(record_id, sufficient_sleep)
write.csv(sufficient_sleep_df, "/Volumes/dept/SOM/Peds/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Erin Cobry/JDRF Career Development Grant/Phase 1 Manuscript/Data_clean/sufficient_sleep.csv", row.names = FALSE)
demog_df <- full_join(demog_df, sufficient_sleep_df, by = "record_id")
```
...
```{r, include=FALSE}
t2a <- tableby(sufficient_sleep ~ as.factor(season) + gender_m_fo + age + age_cat + as.factor(stateresidence) + rurality + race + as.factor(childsgradeinschool) + as.factor(school_format) + 
diabetesduration + insulinmethod + as.factor(pump_brand) + current_cgm_use + as.factor(cgm_type) + 
currenthcltech + as.factor(dka) + as.factor(severe_hypo_episode) +  
parenteducation + as.factor(child_sleep_condition) + as.factor(child_nightime_awakening) + nightime_awakening_2 + parent_sleep_concerns + concern_sleep_disorder + intvent_benefit + hba1c + as.factor(mstage2) + 
as.factor(fstage2) + as.factor(drstage) + as.factor(self_stage), data = demog_df)
...
```{r, include=FALSE}
t3 <- tableby(age_cat ~ onsetlatency_avg + sleepefficency_avg + waso_avg + totalsleep_avg_analysis, data = analysis)
```
...
```{r, include=FALSE}
t4 <- tableby(age_cat ~ sensor_70_180 + sensor_hypoglycemic + sensor_hyperglycemic + sensor_mean, data = analysis)
```
...
```{r, include=FALSE}
t5 <- tableby(sufficient_sleep ~ mesc_total + SRDB_score + hfs_total + c_sleep_disturbance_tscore +  c_sleep_impairment_tscore + c_life_satisfaction_tscore +  c_physical_tscore +
                p_physical_tscore + c_positive_affect_tscore + p_positive_affect_tscore + c_psychological_stress_tscore + p_psychological_stress_tscore + c_anger_tscore +
                p_anger_tscore + c_anxiety_tscore + p_anxiety_tscore + c_depressive_tscore + p_depressive_tscore + c_family_tscore + promis_parent_proxy_sf_v10_fam_relationships_8a_tscore +
                c_peer_tscore, data = analysis)
...
# Measures by sleep efficiency

```{r, include=FALSE}
t5 <- tableby(sufficient_sleep ~ sensor_70_180 + sensor_hypoglycemic + sensor_hyperglycemic + sensor_mean + onsetlatency_avg + sleepefficency_avg + waso_avg + totalsleep_avg_analysis + mesc_total + 
                SRDB_score + hfs_total + c_sleep_disturbance_tscore +  c_sleep_impairment_tscore + c_life_satisfaction_tscore +  c_physical_tscore +
                p_physical_tscore + c_positive_affect_tscore + p_positive_affect_tscore + c_psychological_stress_tscore + p_psychological_stress_tscore + c_anger_tscore +
                p_anger_tscore + c_anxiety_tscore + p_anxiety_tscore + c_depressive_tscore + p_depressive_tscore + c_family_tscore + promis_parent_proxy_sf_v10_fam_relationships_8a_tscore +
                c_peer_tscore, data = analysis)
...
```{r, include=FALSE}
t6 <- tableby(gender_m_fo ~ sensor_70_180 + sensor_hypoglycemic + sensor_hyperglycemic + sensor_mean + onsetlatency_avg + sleepefficency_avg + waso_avg + totalsleep_avg_analysis + mesc_total + 
                SRDB_score + hfs_total + c_sleep_disturbance_tscore +  c_sleep_impairment_tscore + c_life_satisfaction_tscore +  c_physical_tscore +
                p_physical_tscore + c_positive_affect_tscore + p_positive_affect_tscore + c_psychological_stress_tscore + p_psychological_stress_tscore + c_anger_tscore +
                p_anger_tscore + c_anxiety_tscore + p_anxiety_tscore + c_depressive_tscore + p_depressive_tscore + c_family_tscore + promis_parent_proxy_sf_v10_fam_relationships_8a_tscore +
                c_peer_tscore, data = analysis)
