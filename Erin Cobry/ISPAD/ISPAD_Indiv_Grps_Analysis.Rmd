...
fit_ind_mod = function(outcome,df,plot = T,diagnostics = F){
  ...
  print(kable(mod_means$contrasts[c(1,2,6,13,14,15),],digits = 3,caption = "Timepoint Means"))
...
* Sleep Efficacy: The average sleep efficiency (child) for those in the Poor Parent Sleeper group dropped by 3.06 (95%CI: 0.86, 5.26) percent from Baseline to 6 Months (p = 0.049). There was no significant change over time from Baseline to 3 Months and 3 Months to 6 Months (p = .88, .55)
...
#### Poor Sleeper Groups
#### Parent
* Total Z Score: The average HFS Z Score (Parent) for those in the Poor Parent Sleeper group increased by 0.57 (95%CI: 0.170, 0.974) from Baseline to 3 Months (p = 0.040), and by 0.628 (95%CI: 0.226, 1.03) from Baseline to 6 Months. There was no significant change over time from 3 Months to 6 Months (p = .99)
* Maintain High BG: No significant change over time (p = .99, .99, .98)
* Worry Low BG: The average "Worry Low BG" Component (Parent) for those in the Poor Parent Sleeper group increased by 5.4 points (95%CI: 2.20, 8.55) from Baseline to 3 Months (p = 0.009), and by 4.9 points (95%CI: 1.73 8.08) from Baseline to 6 Months. There was no significant change over time from 3 Months to 6 Months (p = .99)
...
* Worry Low BG: The average "Worry Low BG" Component (child) for those in the Poor Parent Sleeper group increased by 3.27 (95%CI: 0.92, 5.62) percent from Baseline to 6 Months (p = 0.047). There was no significant change over time from Baseline to 3 Months and 3 Months to 6 Months (p = .39, .92)
* Worry Negative Social Consequences: No significant change over time (p = .10, .14, .99)
```{r results hfs}
3.273 + c(-1,1)*1.96*1.199
# parent
