...
```{r results='asis'}
# n 
cshq %>% filter(childrens_sleep_habits_questionnaire_27_complete == "Complete") %>% group_by(timepoint) %>% summarize(n = n())
# mod
...
```{r results='asis'}
# n 
paid_p %>% filter(paidpeds_complete == "Complete") %>%group_by(timepoint) %>% summarize(n = n())
# mod
...
```{r results='asis'}
# n 
paid_pr %>% filter(paidpr_complete == "Complete") %>% group_by(timepoint) %>% summarize(n = n())
# mod
...
```{r results='asis'}
# n 
pedsql_pr_t %>% filter(pedsql_parent_report_for_teens_1318_complete == "Complete") %>% group_by(timepoint) %>% summarize(n = n())
# mod
...
```{r results='asis'}
# n 
pedsql_pr_c %>% filter(pedsql_parent_report_for_children_812_complete == "Complete") %>% group_by(timepoint) %>% summarize(n = n())
# mod
...
```{r results='asis'}
# n 
pedsql_pr_yc %>% filter(pedsql_parent_report_for_young_children_57_complete == "Complete") %>% group_by(timepoint) %>% summarize(n = n())
# mod
...
```{r results='asis'}
# n 
pedsql_pr_t %>% filter(pedsql_parent_report_for_toddlers_24_complete == "Complete") %>% group_by(timepoint) %>% summarize(n = n())
# mod
fit_mod(outcome = "pedsql_pr_t_total", df = pedsql_pr_t)
```
...
```{r results='asis'}
# n 
pedsql_t %>% filter(pedsql_teen_report_1318_complete == "Complete") %>% group_by(timepoint) %>% summarize(n = n())
# mod
...
```{r results='asis'}
# n 
pedsql_c %>% filter(pedsql_child_report_812_complete == "Complete") %>% group_by(timepoint) %>% summarize(n = n())
# mod
...
```{r results='asis'}
# n 
pedsql_yc %>% filter(pedsql_young_child_report_57_complete == "Complete") %>% group_by(timepoint) %>% summarize(n = n())
# mod
...
# set levels
inspire_pb[3:23] = lapply(inspire_pb[3:23], function(x) {levels(x) = c(0,1,2,3,4, -99);x } )
...
# set levels
inspire_pf[3:23] = lapply(inspire_pf[3:23], function(x) {levels(x) = c(0,1,2,3,4, -99);x } )
...
```{r results='asis'}
# n 
inspire_p %>% filter(inspire_parent_baseline_complete == "Complete") %>% group_by(timepoint) %>% summarize(n = n())
inspire_p %>% filter(inspire_parent_follow_up_complete == "Complete") %>% group_by(timepoint) %>% summarize(n = n())
...
```{r results='asis'}
# n 
inspire_y %>% filter(inspire_youth_baseline_complete == "Complete") %>% group_by(timepoint) %>% summarize(n = n())
inspire_y %>% filter(inspire_youth_follow_up_complete == "Complete") %>% group_by(timepoint) %>% summarize(n = n())
...
```{r results='asis'}
# n 
psqi %>% group_by(timepoint) %>% summarize(n = n())
# mod
...
```{r results='asis'}
# n 
promis_peds %>%  group_by(timepoint) %>% summarize(n = n())
# mod
...
```{r results='asis'}
# n 
promis_parent %>% group_by(timepoint) %>% summarize(n = n())
# mod
