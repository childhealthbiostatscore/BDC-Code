...
label(data$automode_start)="Date of AM start"
...
data$redcap_event_name.factor = factor(data$redcap_event_name,levels=c("baseline_arm_1","1_arm_1","2_arm_1","3_arm_1","4_arm_1","5_arm_1","baseline_arm_2","1_arm_2","2_arm_2","3_arm_2","4_arm_2","5_arm_2"))
...
data$demographics_pumphx.factor = factor(data$demographics_pumphx,levels=c("1","2","3","4","5","6"))
data$demographics_cgmhx.factor = factor(data$demographics_cgmhx,levels=c("1","2","3","4","5","6"))
...
levels(data$redcap_event_name.factor)=c("Baseline (Arm 1: Child)","1 (Arm 1: Child)","2 (Arm 1: Child)","3 (Arm 1: Child)","4 (Arm 1: Child)","5 (Arm 1: Child)","Baseline (Arm 2: Young Adult )","1 (Arm 2: Young Adult )","2 (Arm 2: Young Adult )","3 (Arm 2: Young Adult )","4 (Arm 2: Young Adult )","5 (Arm 2: Young Adult )")
...
levels(data$demographics_pumphx.factor)=c("< 1 month","1-6 months","6 mnths - 1 yr","1-3 years","3-5 years",">5 years")
levels(data$demographics_cgmhx.factor)=c("< 1 month","1-6 months","6 mnths - 1 yr","1-3 years","3-5 years",">5 years")
levels(data$demographics_complete.factor)=c("Incomplete","Unverified","Complete")
levels(data$gyl_timepoint.factor)=c("Baseline","Month 1","Time 1","Time 2","Time 3","Time 4")
levels(data$glycemic_data_2d4b_complete.factor)=c("Incomplete","Unverified","Complete")
levels(data$timepoint.factor)=c("baseline","month 1","Time 1","Time 2","Time 3","Time 4")
