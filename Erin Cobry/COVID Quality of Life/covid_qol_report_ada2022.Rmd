...
scores_child = scores_child  %>% rowwise() %>% mutate(dmq_score = sum(c_across(adjust:miss))/20 *25)
...
scores = scores  %>% rowwise() %>% mutate(dmq_score = sum(c_across(adjust:miss))/20 *25)
