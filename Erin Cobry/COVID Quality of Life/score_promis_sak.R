...
setwd("S:/Laura/BDC/Projects")

##########
# sheets #
##########
peds_lifesatisfaction_short <- read_excel("S:/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Life Satisfaction T-tables.xlsx", 
                                         sheet = "Pedaitric Life Satisfaction 4a")

peds_physact_short <- read_excel("S:/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Physical Activity T-tables.xlsx", 
                                          sheet = "Pediatric Physical Activity 4a")
pp_physact_short = read_excel("S:/Laura/BDC/Projects//Erin Cobry/ADA 2022/COVID/Data clean/Physical Activity T-tables.xlsx", 
                                 sheet = "Parent Proxy Phys Activity 4a")

peds_posaff_short <- read_excel("S:/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Positive Affect T-tables.xlsx", 
                                 sheet = "Pediatric Positive Affect 4a")
pp_posaff_short = read_excel("S:/Laura/BDC/Projects//Erin Cobry/ADA 2022/COVID/Data clean/Positive Affect T-tables.xlsx", 
                              sheet = "Parent Proxy Positive Affect 4a")

peds_pse_short <- read_excel("S:/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Psychological Stress Experience T-tables.xlsx", 
                                sheet = "Pediatric Psych Stress Exp 4a")
pp_pse_short = read_excel("S:/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Psychological Stress Experience T-tables.xlsx", 
...
peds_anx_short <- read_excel("S:/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Anxiety T-tables.xlsx", 
                             sheet = "Pediatric Anxiety 8a")
pp_anx_short = read_excel("S:/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Anxiety T-tables.xlsx", 
                          sheet = "Parent Proxy Anxiety 8a")

psr_anx_short = read_excel("S:/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Anxiety T-tables.xlsx", 
                          sheet = "Parent (Adult) Anxiety 4a")

peds_dep_short <- read_excel("S:/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Depression T-tables.xlsx", 
                             sheet = "Pedaitric Depressive Symptoms 8")
pp_dep_short = read_excel("S:/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Depression T-tables.xlsx", 
                          sheet = "Parent Proxy Depressive Sx 6a")

psr_dep_short = read_excel("S:/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Depression T-tables.xlsx", 
                           sheet = "Parent (Adult) Depression 4a")


peds_pr_short <- read_excel("S:/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Relationships T-tables.xlsx", 
                             sheet = "Pediatric Peer Relationships 8a")

peds_fr_short <- read_excel("S:/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data clean/Relationships T-tables.xlsx", 
...
source("S:/Laura/BDC/Projects/Erin Cobry/ADA 2022/COVID/Data raw/HealthRelatedQuality-PROMISPeds_R_2022-02-01_1915.r")
promis_peds <- data
...
# Convert to T scores
peds_disturbance_short = read.csv("S:/Laura/BDC/Projects//Erin Cobry/ADA 2022/COVID/Data clean/peds_sleep_disturbance_short.csv")
peds_impairment_short = read.csv("S:/Laura/BDC/Projects//Erin Cobry/ADA 2022/COVID/Data clean/peds_sleep_impairment_short.csv")
...
source("S:/Laura/BDC/Projects//Erin Cobry/ADA 2022/COVID/Data raw/HealthRelatedQuality-PROMISParentProxy_R_2022-02-01_1916.r")
...
# Convert to T scores
parent_disturbance_short = read.csv("S:/Laura/BDC/Projects//Erin Cobry/ADA 2022/COVID/Data clean/parent_proxy_sleep_disturbance_short.csv")
parent_impairment_short = read.csv("S:/Laura/BDC/Projects//Erin Cobry/ADA 2022/COVID/Data clean/parent_proxy_sleep_impairment_short.csv")
...
source("S:/Laura/BDC/Projects//Erin Cobry/ADA 2022/COVID/Data raw/HealthRelatedQuality-PROMISParentSelfRepo_R_2022-02-01_1917.r")
promis_parent <- data
...
# Convert to T scores
parent_self_disturbance_short = read.csv("S:/Laura/BDC/Projects//Erin Cobry/ADA 2022/COVID/Data clean/parent_self_disturbance_short.csv")
parent_self_impairment_short = read.csv("S:/Laura/BDC/Projects//Erin Cobry/ADA 2022/COVID/Data clean/parent_self_impairment_short.csv")
