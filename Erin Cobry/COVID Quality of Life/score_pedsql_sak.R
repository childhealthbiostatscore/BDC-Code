...
data57 <- read.csv("./Erin Cobry/ADA 2022/COVID/Data raw/HealthRelatedQuality-PedsQLAges57_DATA_2022-02-01_1822.csv",na.strings = c("",NA))
...
data817 <- read.csv("./Erin Cobry/ADA 2022/COVID/Data raw/HealthRelatedQuality-PedsQLAges817_DATA_2022-02-01_1823.csv",na.strings = c("",NA))
# first we need to fix scoring
...
dataparent <- read.csv("./Erin Cobry/ADA 2022/COVID/Data raw/HealthRelatedQuality-PedsQLParentProxyAge_DATA_2022-02-01_1823.csv",na.strings = c("",NA))
# first we need to fix scoring
