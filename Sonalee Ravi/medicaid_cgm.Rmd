...
### Table 8: Descriptive statistics for all individuals with TIR
...
### Figure 3: Correlation between TIR and HbA1c
...
```{r echo=FALSE}
# Model
tir_mod <- lme(HbA1c ~ CGMOKPercent-1,random = ~1|EPICMRN,data = tir,na.action = na.omit)
```
