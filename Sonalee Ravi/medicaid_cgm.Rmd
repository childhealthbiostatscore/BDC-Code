...
# Read in CGM data
filename <- paste0(pathstart,"som/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Sonalee Ravi/Medicaid CGM/Data_Cleaned/30 day cgm metrics.csv")
...
Mean (SD) CGM use in days across all subjects and all visits (excluding missing values):
```{r echo=FALSE}
print(paste0(round(mean(dat$X30.day.CGM.use,na.rm = T),3)," (",
       round(sd(dat$X30.day.CGM.use,na.rm = T),3),")"))
```
