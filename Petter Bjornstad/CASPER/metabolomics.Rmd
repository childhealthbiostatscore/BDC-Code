...
knitr::opts_chunk$set(echo = FALSE,cache = TRUE,dpi = 600)
...
```{r}
vars = c("GIR","GIR_per_kg","body_fat","screen_bmi_percentile","gfr",	
         "rpf","acr_mean","kidney_oxygenation")
varnames = c("GIR","GIR per kg","Body fat","BMI %ile","GFR","RPF",
             "Mean ACR","Kidney Oxy.")
add_vars = c("kidney_GFR","medullary_GFR","cortex_GFR")
```
