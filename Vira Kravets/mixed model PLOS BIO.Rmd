...
# read in fig 2K
fig2k <- read.csv("B:/Projects/Vira Kravets/PLOS BIO resubmission/1st resp Large bins (Fig 2K).csv")
fig2k$X <- NULL
fig2k$id <- fig2k$ï..
fig2k$ï..<- NULL
...
# read in fig 2L
fig2L <- read.csv("B:/Projects/Vira Kravets/PLOS BIO resubmission/last resp Large bins (Fig 2L).csv")
fig2L$X <- NULL
fig2L$id <- fig2L$ï..
fig2L$ï..<- NULL
