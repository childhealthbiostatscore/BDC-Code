...
# make a long dataset
fig1f_long <- reshape(fig1f, direction="long", idvar = "ID", varying = c("X1st.resp","w.or","w.end","last.resp",
                                                                         "hub.like..p1.","hub.like..p2."))
...
mod_1f <- lme(last.resp ~ X1st.resp,random=~1|islet,data = fig1f,na.action=na.omit)
