...
Interpretation of model above: for a 1% increase in initial, repeated increases by `r summary(mod_2d)$tTable[2,1]`%.
...
Interpretation of model above: for a 1% increase in glucose, glibencl increases by `r summary(mod_3b)$tTable[2,1]`%.
...
Interpretation of model above: for a 1% increase in glucose, glibencl increases by `r summary(mod_3d)$tTable[2,1]`%.

```{r echo=FALSE, comment=""}
a_3d
shapiro.test(resid(mod_3d))
r2(mod_3d)
```
<br>
...
Interpretation of model above: for a 1% increase in glucose, glibencl increases by `r summary(mod_3e)$tTable[2,1]`%.

```{r echo=FALSE, comment=""}
a_3e
shapiro.test(resid(mod_3e))
r2(mod_3e)
```
<br>
