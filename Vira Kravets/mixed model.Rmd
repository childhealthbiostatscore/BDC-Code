...
Interpretation of model above: for a 1% increase in glucose, glibencl changes by `r summary(mod_3d)$tTable[2,1]`%.
...
Interpretation of model above: for a 1% increase in glucose, glibencl changes by `r summary(mod_3e)$tTable[2,1]`%.
