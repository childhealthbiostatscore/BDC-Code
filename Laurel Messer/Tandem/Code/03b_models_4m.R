...
dat<-subset(dat,dat$post4m_complete_yn==1)
dat.model<-dat[,c(1,6,30,116:117,137,142:144,214,228:238)]
#might have to do this:
dat.model$change1_satis<-dat.model$post4m_factor1-dat.model$baseline_factor1
dat.model$change2_satis<-dat.model$post6m_factor1-dat.model$post4m_factor1

dat.model$change1_burden<-dat.model$post4m_factor2-dat.model$baseline_factor2
dat.model$change2_burden<-dat.model$post6m_factor2-dat.model$post4m_factor2
...
change1.satis<-lm(dat.model$change1_satis~dat.model$method_cat+dat.model$cgm_yn+dat.model$Baseline_A1C+
                    dat.model$BaselineAGE+dat.model$B_RESPONDENT)
...
change1.burden<-lm(dat.model$change1_burden~dat.model$method_cat+dat.model$cgm_yn+dat.model$BaselineAGE
                   +dat.model$Baseline_A1C+dat.model$B_RESPONDENT)
