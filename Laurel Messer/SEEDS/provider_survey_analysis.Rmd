...
summary(current_practices,labelTranslations = my_labels,total=FALSE,pfootnote = TRUE)
```
...
```{r results='asis'}
comfort = c("cgmcomfort","cgmcanidacy","cgmqs","cgminscov","cgmprescription","cgmtraining","cgmreview",
