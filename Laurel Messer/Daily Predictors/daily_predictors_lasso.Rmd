...
lambda_cv = function(df,outcome_name,folds = 5,
                       lambdas = seq(0,200),core_ratio = 0.5){
  # Make model formula
...
# Time this code
ptm <- proc.time()
lambda_perf = lambda_cv(df = bolus_morning,outcome_name = "boluses",lambdas = seq(0,10))
proc.time() - ptm
