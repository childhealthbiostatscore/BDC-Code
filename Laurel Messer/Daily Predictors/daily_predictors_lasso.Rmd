...
data = data[-which.max(data$n_highalerts),]
...
lambda_cv = function(df,outcome_name,fam = "gaussian",n_lambda = 20,folds = 5,
...
2. The maximum dm_caretime is 900 (ID 86) and the maximum dm_thinktime is 12,120 (ID 10). Are these correct? Also the maximum n_highalerts is 10,000,000, which I assume is a mistake.

```{r}
invisible(lapply(outcomes, function(o){
  hist(data[,o])
}))
```
