...
# Plot
upset(selected_morning,nsets = ncol(selected_morning),order.by = "freq",mb.ratio = c(0,1))
```
...
bolus_evening = data[,c(id_vars,evening_items,"next_day_boluses")]
bolus_evening = bolus_evening[complete.cases(bolus_evening),]
# CV for lambda values
lambda_perf = lambda_cv(df = bolus_evening,outcome_name = "next_day_boluses",fam = fam)
best = best_lambdas(lambda_perf,"RMSE",num_coef_lower = 5,num_coef_higher = 10)
# Fit model
form = as.formula(paste0("next_day_boluses~",paste0(evening_items,collapse = "+")))
...
fam = gaussian()
# Get evening variables
smg_evening = data[,c(id_vars,evening_items,"next_day_smg")]
smg_evening = smg_evening[complete.cases(smg_evening),]
# CV for lambda values
lambda_perf = lambda_cv(df = smg_evening,outcome_name = "next_day_smg",fam = fam)
best = best_lambdas(lambda_perf,"RMSE",num_coef_lower = 5,num_coef_higher = 10)
# Fit model
form = as.formula(paste0("next_day_smg~",paste0(evening_items,collapse = "+")))
...
fam = gaussian()
# Get evening variables
tir_evening = data[,c(id_vars,evening_items,"next_day_tir")]
tir_evening = tir_evening[complete.cases(tir_evening),]
# CV for lambda values
lambda_perf = lambda_cv(df = tir_evening,outcome_name = "next_day_tir",fam = fam)
best = best_lambdas(lambda_perf,"RMSE",num_coef_lower = 5,num_coef_higher = 10)
# Fit model
form = as.formula(paste0("next_day_tir~",paste0(evening_items,collapse = "+")))
...
fam = poisson(link = "log")
# Get evening variables
alerts_evening = data[,c(id_vars,evening_items,"next_day_n_highalerts")]
alerts_evening = alerts_evening[complete.cases(alerts_evening),]
# CV for lambda values
lambda_perf = lambda_cv(df = alerts_evening,outcome_name = "next_day_n_highalerts",fam = fam)
best = best_lambdas(lambda_perf,"RMSE",num_coef_lower = 5,num_coef_higher = 10)
# Fit model
form = as.formula(paste0("next_day_n_highalerts~",paste0(evening_items,collapse = "+")))
...
fam = poisson(link = "log")
# Get evening variables
caretime_evening = data[,c(id_vars,evening_items,"next_day_dm_caretime")]
caretime_evening = caretime_evening[complete.cases(caretime_evening),]
# Transform outcome - cube root
caretime_evening$next_day_dm_caretime = (caretime_evening$next_day_dm_caretime)^(1/3)
# CV for lambda values
lambda_perf = lambda_cv(df = caretime_evening,outcome_name = "next_day_dm_caretime",fam = fam)
best = best_lambdas(lambda_perf,"RMSE",num_coef_lower = 5,num_coef_higher = 10)
# Fit model
form = as.formula(paste0("next_day_dm_caretime~",paste0(evening_items,collapse = "+")))
...
fam = poisson(link = "log")
# Get evening variables
thinktime_evening = data[,c(id_vars,evening_items,"next_day_dm_thinktime")]
thinktime_evening = thinktime_evening[complete.cases(thinktime_evening),]
# Transform outcome - cube root
thinktime_evening$next_day_dm_thinktime = (thinktime_evening$next_day_dm_thinktime)^(1/3)
# CV for lambda values
lambda_perf = lambda_cv(df = thinktime_evening,outcome_name = "next_day_dm_thinktime",fam = fam)
best = best_lambdas(lambda_perf,"RMSE",num_coef_lower = 5,num_coef_higher = 10)
# Fit model
form = as.formula(paste0("next_day_dm_thinktime~",paste0(evening_items,collapse = "+")))
...
fam = gaussian()
# Get evening variables
gsq_evening = data[,c(id_vars,evening_items,"next_day_gsq")]
gsq_evening = gsq_evening[complete.cases(gsq_evening),]
# CV for lambda values
lambda_perf = lambda_cv(df = gsq_evening,outcome_name = "next_day_gsq",fam = fam)
best = best_lambdas(lambda_perf,"RMSE",num_coef_lower = 5,num_coef_higher = 10)
# Fit model
form = as.formula(paste0("next_day_gsq~",paste0(evening_items,collapse = "+")))
...
fam = binomial()
# Get evening variables
combined_evening = data[,c(id_vars,evening_items,"next_day_combined")]
combined_evening = combined_evening[complete.cases(combined_evening),]
# CV for lambda values
lambda_perf = lambda_cv(df = combined_evening,outcome_name = "next_day_combined",fam = fam)
best = best_lambdas(lambda_perf,"RMSE",num_coef_lower = 5,num_coef_higher = 10)
# Fit model
form = as.formula(paste0("next_day_combined~",paste0(evening_items,collapse = "+")))
...
# Plot
upset(selected_evening,nsets = ncol(selected_evening),order.by = "freq",mb.ratio = c(0,1))
```
...
```{r}
kable(cbind(morning_items,labels(data[,morning_items])),
      col.names = c("Item","Question"),row.names = F)
```

## Evening items

```{r}
kable(cbind(evening_items,labels(data[,evening_items])),
      col.names = c("Item","Question"),row.names = F)
```