...
p_tir = ggplot(data,aes_string(x = "record_id",y = "tir")) + 
    geom_boxplot() + theme_bw(base_size = 15) + ylab("TIR (%)") +
    theme(axis.text.x=element_blank(),axis.title.x = element_blank(),
          axis.ticks.x=element_blank())
p_smg = ggplot(data,aes_string(x = "record_id",y = "smg")) + 
    geom_boxplot() + theme_bw(base_size = 15) + ylab("Mean Glucose (mg/dL)") +
    theme(axis.text.x=element_blank(),axis.title.x = element_blank(),
          axis.ticks.x=element_blank())
p_bol = ggplot(data[data$boluses < 40,],aes_string(x = "record_id",y = "boluses")) + 
    geom_boxplot() + theme_bw(base_size = 15) + ylab("Boluses in One Day") +
    theme(axis.text.x=element_blank(),
          axis.ticks.x=element_blank()) + xlab("Participant")
