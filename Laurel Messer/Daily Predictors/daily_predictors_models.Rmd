...
for (v in 2:length(morning_items)) {
  ...
  r$effect = NULL
  if(v>2){
    r$term = levels(df[,var])
    r$term[1] = paste(r$term[1],"(Reference group)")
  }
