...
knitr::opts_knit$set(root.dir = "/home/tim/Desktop/cgmanalysis Comparisons/Medtronic, Dexcom, Libre")
library(arsenal)
library(skimr)
library(knitr)
library(caret)
...
under_54 <- ggplot(dexcom_package,aes(x = percent_time_under_54,y = X.54)) +
  ...
  annotate("text",x=0.5,y=3.75,label=paste("NRMSE:",round(RMSE(dexcom_package$percent_time_under_54,
                                                               dexcom_package$X.54)/mean(dexcom_package$X.54),3),"\n",
                                           "R2:",round(R2(dexcom_package$percent_time_under_54,
...
under_70 <- ggplot(dexcom_package,aes(x = percent_time_under_70,y = X.70)) +
  ...
  annotate("text",x=2.5, y=14.5, label=paste("NRMSE:",round(RMSE(dexcom_package$percent_time_under_70,
                                                                 dexcom_package$X.70)/mean(dexcom_package$X.70),3),"\n",
                                             "R2:",round(R2(dexcom_package$percent_time_under_70,
...
tir_70_180 <- ggplot(dexcom_package,aes(x = percent_time_70_180,y = X70.180)) +
  ...
  annotate("text",x=30, y=95, label=paste("NRMSE:",round(RMSE(dexcom_package$percent_time_70_180,
                                                              dexcom_package$X70.180)/mean(dexcom_package$X70.180),3),"\n",
                                          "R2:",round(R2(dexcom_package$percent_time_70_180,
...
over_180 <- ggplot(dexcom_package,aes(x = percent_time_over_180,y = X.180)) +
  ...
  annotate("text",x=10, y=80, label=paste("NRMSE:",round(RMSE(dexcom_package$percent_time_over_180,
                                                              dexcom_package$X.180)/mean(dexcom_package$X.180),3),"\n",
                                          "R2:",round(R2(dexcom_package$percent_time_over_180,
...
over_250 <- ggplot(dexcom_package,aes(x = percent_time_over_250,y = X.250)) +
  ...
  annotate("text",x=5, y=37.5, label=paste("NRMSE:",round(RMSE(dexcom_package$percent_time_over_250,
                                                               dexcom_package$X.250)/mean(dexcom_package$X.250),3),"\n",
                                           "R2:",round(R2(dexcom_package$percent_time_over_250,
...
sd <- ggplot(dexcom_package,aes(x = standard_deviation,y = SD)) +
  ...
  annotate("text",x=30, y=95, label=paste("NRMSE:",round(RMSE(dexcom_package$percent_time_over_180,
                                                              dexcom_package$X.180)/mean(dexcom_package$X.180),3),"\n",
                                          "R2:",round(R2(dexcom_package$percent_time_over_180,
                                                         dexcom_package$X.180),3)))
# Layout
...
under_54 <- ggplot(dexcom_tandem_package,aes(x = percent_time_under_54_tandem,y = tandem_u54)) +
  ...
  ggtitle("% Time Under 54 mg/dL") +
  annotate("text",x=0.25, y=1.9, label=paste("NRMSE:",round(RMSE(dexcom_tandem_package$percent_time_under_54_tandem,
                                                                 dexcom_tandem_package$tandem_u54)/
                                                              mean(dexcom_tandem_package$tandem_u54),3),"\n",
                                             "R2:",round(R2(dexcom_tandem_package$percent_time_under_54_tandem,
...
under_70 <- ggplot(dexcom_tandem_package,aes(x = percent_time_under_70_tandem,y = tandem_u70)) +
  ...
  ggtitle("% Time Under 70 mg/dL") +
  annotate("text",x=1, y=6.5, label=paste("NRMSE:",round(RMSE(dexcom_tandem_package$percent_time_under_70_tandem,
                                                              dexcom_tandem_package$tandem_u70)/
                                                           mean(dexcom_tandem_package$tandem_u70),3),"\n",
                                          "R2:",round(R2(dexcom_tandem_package$percent_time_under_70_tandem,
...
tir_70_180 <- ggplot(dexcom_tandem_package,aes(x = percent_time_70_180_tandem,y = tandem_70_180)) +
  ...
  ggtitle("% Time 70 - 180 mg/dL") +
  annotate("text",x=50, y=82.5, label=paste("NRMSE:",round(RMSE(dexcom_tandem_package$percent_time_70_180_tandem,
                                                                dexcom_tandem_package$tandem_70_180)/
                                                             mean(dexcom_tandem_package$tandem_70_180),3),"\n",
                                            "R2:",round(R2(dexcom_tandem_package$percent_time_70_180_tandem,
...
over_180 <- ggplot(dexcom_tandem_package,aes(x = percent_time_over_180_tandem,y = tandem_a180)) +
  ...
  ggtitle("% Time Over 180 mg/dL") +
  annotate("text",x=15, y=47.5, label=paste("NRMSE:",round(RMSE(dexcom_tandem_package$percent_time_over_180_tandem,
                                                                dexcom_tandem_package$tandem_a180)/
                                                             mean(dexcom_tandem_package$tandem_a180),3),"\n",
                                            "R2:",round(R2(dexcom_tandem_package$percent_time_over_180_tandem,
...
over_250 <- ggplot(dexcom_tandem_package,aes(x = percent_time_over_250_tandem,y = tandem_a250)) +
  ...
  ggtitle("% Time Over 250 mg/dL") +
  annotate("text",x=2.5, y=19, label=paste("NRMSE:",round(RMSE(dexcom_tandem_package$percent_time_over_250_tandem,
                                                               dexcom_tandem_package$tandem_a250)/
                                                            mean(dexcom_tandem_package$tandem_a250),3),"\n",
                                           "R2:",round(R2(dexcom_tandem_package$percent_time_over_250_tandem,
...
sd <- ggplot(dexcom_tandem_package,aes(x = sd_tandem,y = tandem_sd)) +
  ...
  ggtitle("Standard Deviation") +
  annotate("text",x=45, y=74, label=paste("NRMSE:",round(RMSE(dexcom_tandem_package$sd_tandem,
                                                              dexcom_tandem_package$tandem_sd)/
                                                           mean(dexcom_tandem_package$tandem_sd),3),"\n",
                                          "R2:",round(R2(dexcom_tandem_package$sd_tandem,
...
under_54 <- ggplot(libre_package,aes(x = percent_time_under_54,y = X.54)) +
  ...
  coord_fixed(ratio = 1,xlim = c(0,15),ylim = c(0,15)) +
  ggtitle("% Time Under 54 mg/dL") +
  annotate("text",x=2.5, y=14, label=paste("NRMSE:",round(RMSE(libre_package$percent_time_under_54,
                                                               libre_package$X.54)/
                                                            mean(libre_package$X.54),3),"\n",
                                           "R2:",round(R2(libre_package$percent_time_under_54,
...
under_70 <- ggplot(libre_package,aes(x = percent_time_under_70,y = X.70)) +
  ...
  ggtitle("% Time Under 70 mg/dL") +
  annotate("text",x=2.5, y=21, label=paste("NRMSE:",round(RMSE(libre_package$percent_time_under_70,
                                                               libre_package$X.70)/
                                                            mean(libre_package$X.70),3),"\n",
                                           "R2:",round(R2(libre_package$percent_time_under_70,
...
tir_70_180 <- ggplot(libre_package,aes(x = percent_time_70_180,y = X70.180)) +
  ...
  ggtitle("% Time 70 - 180 mg/dL") +
  annotate("text",x=10, y=95, label=paste("NRMSE:",round(RMSE(libre_package$percent_time_70_180,
                                                              libre_package$X70.180)/
                                                           mean(libre_package$X70.180),3),"\n",
                                          "R2:",round(R2(libre_package$percent_time_70_180,
...
over_180 <- ggplot(libre_package,aes(x = percent_time_over_180,y = X.180)) +
  ...
  coord_fixed(ratio = 1,xlim = c(0,100),ylim = c(0,100)) +
  ggtitle("% Time Over 180 mg/dL") +
  annotate("text",x=10, y=95, label=paste("NRMSE:",round(RMSE(libre_package$percent_time_over_180,
                                                              libre_package$X.180)/
                                                           mean(libre_package$X.180),3),"\n",
                                          "R2:",round(R2(libre_package$percent_time_over_180,
...
over_250 <- ggplot(libre_package,aes(x = percent_time_over_250,y = X.250)) +
  ...
  ggtitle("% Time Over 250 mg/dL") +
  annotate("text",x=10, y=78, label=paste("NRMSE:",round(RMSE(libre_package$percent_time_over_250,
                                                              libre_package$X.250)/
                                                           mean(libre_package$X.250),3),"\n",
                                          "R2:",round(R2(libre_package$percent_time_over_250,
...
sd <- ggplot(libre_package,aes(x = standard_deviation,y = SD)) +
  ...
  ggtitle("Standard Deviation") +
  annotate("text",x=30, y=107.5, label=paste("NRMSE:",round(RMSE(libre_package$standard_deviation,
                                                              libre_package$SD)/
                                                           mean(libre_package$SD),3),"\n",
                                          "R2:",round(R2(libre_package$standard_deviation,
                                                         libre_package$SD),3)))
...
```{r medtronic lm plots,echo=FALSE,fig.width=8,fig.height=6,warning=FALSE}
# Make plots
tir_40_50 <- ggplot(medtronic_package,aes(x = percent_time_40_50,y = X.40.50.)) +
  ...
  annotate("text",x=0.25, y=1.9, label=paste("NRMSE:",round(RMSE(medtronic_package$percent_time_40_50,
                                                               medtronic_package$X.40.50.)/
                                                            mean(medtronic_package$X.40.50.),3),"\n",
                                           "R2:",round(R2(medtronic_package$percent_time_40_50,
...
tir_50_70 <- ggplot(medtronic_package,aes(x = percent_time_50_70,y = X.50.70.)) +
  ...
  annotate("text",x=1, y=9.25, label=paste("NRMSE:",round(RMSE(medtronic_package$percent_time_50_70,
                                                               medtronic_package$X.50.70.)/
                                                            mean(medtronic_package$X.50.70.),3),"\n",
                                           "R2:",round(R2(medtronic_package$percent_time_50_70,
...
tir_70_180 <- ggplot(medtronic_package,aes(x = percent_time_70_180,y = X.70.180.TIR)) +
  ...
  ggtitle("% Time 70 - 180 mg/dL") +
  annotate("text",x=35, y=87.5, label=paste("NRMSE:",round(RMSE(medtronic_package$percent_time_70_180,
                                                               medtronic_package$X.70.180.TIR)/
                                                            mean(medtronic_package$X.70.180.TIR),3),"\n",
                                           "R2:",round(R2(medtronic_package$percent_time_70_180,
...
tir_180_250 <- ggplot(medtronic_package,aes(x = percent_time_180_250,y = X.180.250.)) +
  ...
  annotate("text",x=5, y=42.5, label=paste("NRMSE:",round(RMSE(medtronic_package$percent_time_180_250,
                                                               medtronic_package$X.180.250.)/
                                                            mean(medtronic_package$X.180.250.),3),"\n",
                                           "R2:",round(R2(medtronic_package$percent_time_180_250,
...
tir_250_400 <- ggplot(medtronic_package,aes(x = percent_time_250_400,y = X.250.400.)) +
  ...
  annotate("text",x=5, y=32.5, label=paste("NRMSE:",round(RMSE(medtronic_package$percent_time_250_400,
                                                               medtronic_package$X.250.400.)/
                                                            mean(medtronic_package$X.250.400.),3),"\n",
                                           "R2:",round(R2(medtronic_package$percent_time_250_400,
