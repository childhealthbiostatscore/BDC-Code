...
# R2 and RMSE
summ <- dexcom_package %>%
  summarise(r2u54 = R2(percent_time_under_54,X.54),
            r2u70 = R2(percent_time_under_70,X.70),
            r270_180 = R2(percent_time_70_180,X70.180),
            r2a180 = R2(percent_time_over_180,X.180),
            r2a250 = R2(percent_time_over_250,X.250),
            r2cv = R2(cv,CV),
            r2sd = R2(standard_deviation,SD),
            
            rmseu54 = RMSE(percent_time_under_54,X.54),
            rmseu70 = RMSE(percent_time_under_70,X.70),
            rmse70_180 = RMSE(percent_time_70_180,X70.180),
            rmsea180 = RMSE(percent_time_over_180,X.180),
            rmsea250 = RMSE(percent_time_over_250,X.250),
            rmsecv = RMSE(cv,CV),
            rmsesd = RMSE(standard_deviation,SD)) %>% round(.,3)
```
...
under_54 <- ggplot(dexcom_package,aes(x = percent_time_under_54,y = X.54)) +
  ...
  geom_text(data = summ,aes(x=0, y=4, label=paste("R2:",r2u54)),hjust=0,inherit.aes = F) +
  geom_text(data = summ,aes(x=0, y=3.75, label=paste("RMSE:",rmseu54)),hjust=0,inherit.aes = F)
under_70 <- ggplot(dexcom_package,aes(x = percent_time_under_70,y = X.70)) +
  ...
  geom_text(data = summ,aes(x=0, y=15, label=paste("R2:",r2u70)),hjust=0,inherit.aes = F) +
  geom_text(data = summ,aes(x=0, y=13.75, label=paste("RMSE:",rmseu70)),hjust=0,inherit.aes = F)
tir_70_180 <- ggplot(dexcom_package,aes(x = percent_time_70_180,y = X70.180)) +
  ...
  geom_text(data = summ,aes(x=20, y=100, label=paste("R2:",r270_180)),hjust=0,inherit.aes = F) +
  geom_text(data = summ,aes(x=20, y=95, label=paste("RMSE:",rmse70_180)),hjust=0,inherit.aes = F)
over_180 <- ggplot(dexcom_package,aes(x = percent_time_over_180,y = X.180)) +
  ...
  geom_text(data = summ,aes(x=0, y=85, label=paste("R2:",r2a180)),hjust=0,inherit.aes = F) +
  geom_text(data = summ,aes(x=0, y=780, label=paste("RMSE:",rmsea180)),hjust=0,inherit.aes = F)
over_250 <- ggplot(dexcom_package,aes(x = percent_time_over_250,y = X.250)) +
  ...
  geom_text(data = summ,aes(x=0, y=40, label=paste("R2:",r2a250)),hjust=0,inherit.aes = F) +
  geom_text(data = summ,aes(x=0, y=37.5, label=paste("RMSE:",rmsea250)),hjust=0,inherit.aes = F)
sd <- ggplot(dexcom_package,aes(x = standard_deviation,y = SD)) +
  geom_point() + theme_bw() + geom_abline() + 
  xlab("cgmanalysis Package") + ylab("Dexcom Software") + 
  coord_fixed(ratio = 1,xlim = c(20,100),ylim = c(20,100)) +
  ggtitle("Standard Deviation") +
  geom_text(data = summ,aes(x=20, y=100, label=paste("R2:",r2sd)),hjust=0,inherit.aes = F) +
  geom_text(data = summ,aes(x=20, y=95, label=paste("RMSE:",rmsesd)),hjust=0,inherit.aes = F)
# Layout
