...
```{r dexcom plots,echo=FALSE,fig.width=8,fig.height=6}
# Make plots
...
```{r libre plots,echo=FALSE,fig.width=8,fig.height=6}
# Make plots
...
```{r medtronic plots,echo=FALSE,fig.width=8,fig.height=6}
# Make plots
