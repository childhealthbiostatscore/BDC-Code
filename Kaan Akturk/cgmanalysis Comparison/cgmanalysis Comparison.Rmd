...
knitr::opts_knit$set(root.dir = "/Users/timvigers/Documents/Work/Kaan Akturk/cgmanalysis Comparisons/Medtronic, Dexcom, Libre")
library(arsenal)
library(skimr)
library(knitr)
library(cgmanalysis)
...
```{r echo=FALSE,results='asis'}
r = tost(dexcom_tandem_package$percent_time_under_54_tandem,dexcom_tandem_package$dex_u54,1)
```
...
```{r echo=FALSE,results='asis'}
r = tost(dexcom_tandem_package$percent_time_under_70_tandem,dexcom_tandem_package$dex_u70,1)
```
...
```{r echo=FALSE,results='asis'}
r = tost(dexcom_tandem_package$percent_time_over_180_tandem,dexcom_tandem_package$dex_a180,2)
```
