...
under_54 <- blandr.draw(dexcom_package$percent_time_under_54,
                        dexcom_package$X.54,
                        y.plot.mode = "proportion",ciDisplay = F) + 
  theme_bw() + ggtitle("% Time Under 54 mg/dL") + ylim(c(-50,200))
under_70 <- blandr.draw(dexcom_package$percent_time_under_70,
                        dexcom_package$X.70,
                        y.plot.mode = "proportion",ciDisplay = F) + 
  theme_bw() + ggtitle("% Time Under 70 mg/dL") + ylim(c(-50,200))
tir_70_180 <- blandr.draw(dexcom_package$percent_time_70_180,
                          dexcom_package$X70.180,
                        y.plot.mode = "proportion",ciDisplay = F) + 
  theme_bw() + ggtitle("% Time 70 - 180 mg/dL") + ylim(c(-50,200))
over_180 <- blandr.draw(dexcom_package$percent_time_over_180,
                        dexcom_package$X.180,
                        y.plot.mode = "proportion",ciDisplay = F) + 
  theme_bw() + ggtitle("% Time Over 180 mg/dL") + ylim(c(-50,200))
over_250 <- blandr.draw(dexcom_package$percent_time_over_250,
                        dexcom_package$X.250,
                        y.plot.mode = "proportion",ciDisplay = F) + 
  theme_bw() + ggtitle("% Time Over 250 mg/dL") + ylim(c(-50,200))
sd <- blandr.draw(dexcom_package$standard_deviation,
                  dexcom_package$SD,
                  y.plot.mode = "proportion",ciDisplay = F) + 
  theme_bw() + ggtitle("Standard Deviation") + ylim(c(-50,200))
# Layout
(under_54 | under_70 | tir_70_180) / (over_180 | over_250 | sd)
```
...
```{r tandem b-a plot,echo=FALSE,warning=F,fig.width=8,fig.height=6}
# Make plots
...
tir_40_50 <- blandr.draw(medtronic_package$percent_time_40_50,
                        ...
                        y.plot.mode = "proportion",ciDisplay = F) + 
  theme_bw() + ggtitle("% Time 40 - 50 mg/dL") + ylim(c(-50,200))
tir_50_70 <- blandr.draw(medtronic_package$percent_time_50_70,
                        medtronic_package$X.50.70.,
                        y.plot.mode = "proportion",ciDisplay = F) + 
  theme_bw() + ggtitle("% Time 50 - 70 mg/dL") + ylim(c(-50,200))
...
tir_180_250 <- blandr.draw(medtronic_package$percent_time_180_250,
                        ...
                        y.plot.mode = "proportion",ciDisplay = F) + 
  theme_bw() + ggtitle("% Time 180 - 250 mg/dL") + ylim(c(-50,200))
