...
under_54 <- ggplot(dexcom_package,aes(x = percent_time_under_54,y = X.54)) +
  ...
  annotate("text",x=1,y=3.5,label=paste("NRMSE:",round(RMSE(dexcom_package$percent_time_under_54,
...
under_70 <- ggplot(dexcom_package,aes(x = percent_time_under_70,y = X.70)) +
  ...
  annotate("text",x=3.5, y=14, label=paste("NRMSE:",round(RMSE(dexcom_package$percent_time_under_70,
...
tir_70_180 <- ggplot(dexcom_package,aes(x = percent_time_70_180,y = X70.180)) +
  ...
  annotate("text",x=40, y=90, label=paste("NRMSE:",round(RMSE(dexcom_package$percent_time_70_180,
...
over_180 <- ggplot(dexcom_package,aes(x = percent_time_over_180,y = X.180)) +
  ...
  annotate("text",x=22, y=80, label=paste("NRMSE:",round(RMSE(dexcom_package$percent_time_over_180,
...
over_250 <- ggplot(dexcom_package,aes(x = percent_time_over_250,y = X.250)) +
  ...
  annotate("text",x=10, y=37.5, label=paste("NRMSE:",round(RMSE(dexcom_package$percent_time_over_250,
...
sd <- ggplot(dexcom_package,aes(x = standard_deviation,y = SD)) +
  ...
  annotate("text",x=40, y=95, label=paste("NRMSE:",round(RMSE(dexcom_package$percent_time_over_180,
                                                              dexcom_package$X.180)/mean(dexcom_package$X.180),3),"\n",
                                          "R2:",round(R2(dexcom_package$percent_time_over_180,
                                                         dexcom_package$X.180),3)))
# Layout
...
under_54 <- ggplot(dexcom_tandem_package,aes(x = percent_time_under_54_tandem,y = tandem_u54)) +
  ...
  ggtitle("% Time Under 54 mg/dL") +
  annotate("text",x=0.5, y=1.8, label=paste("NRMSE:",round(RMSE(dexcom_tandem_package$percent_time_under_54_tandem,
...
under_70 <- ggplot(dexcom_tandem_package,aes(x = percent_time_under_70_tandem,y = tandem_u70)) +
  ...
  ggtitle("% Time Under 70 mg/dL") +
  annotate("text",x=1.8, y=6, label=paste("NRMSE:",round(RMSE(dexcom_tandem_package$percent_time_under_70_tandem,
...
tir_70_180 <- ggplot(dexcom_tandem_package,aes(x = percent_time_70_180_tandem,y = tandem_70_180)) +
  ...
  ggtitle("% Time 70 - 180 mg/dL") +
  annotate("text",x=55, y=82, label=paste("NRMSE:",round(RMSE(dexcom_tandem_package$percent_time_70_180_tandem,
...
over_180 <- ggplot(dexcom_tandem_package,aes(x = percent_time_over_180_tandem,y = tandem_a180)) +
  ...
  ggtitle("% Time Over 180 mg/dL") +
  annotate("text",x=20, y=45, label=paste("NRMSE:",round(RMSE(dexcom_tandem_package$percent_time_over_180_tandem,
...
over_250 <- ggplot(dexcom_tandem_package,aes(x = percent_time_over_250_tandem,y = tandem_a250)) +
  ...
  ggtitle("% Time Over 250 mg/dL") +
  annotate("text",x=5, y=18, label=paste("NRMSE:",round(RMSE(dexcom_tandem_package$percent_time_over_250_tandem,
...
sd <- ggplot(dexcom_tandem_package,aes(x = sd_tandem,y = tandem_sd)) +
  ...
  ggtitle("Standard Deviation") +
  annotate("text",x=50, y=72, label=paste("NRMSE:",round(RMSE(dexcom_tandem_package$sd_tandem,
...
under_54 <- ggplot(libre_package,aes(x = percent_time_under_54,y = X.54)) +
  ...
  coord_fixed(ratio = 1,xlim = c(0,15),ylim = c(0,15)) +
  ggtitle("% Time Under 54 mg/dL") +
  annotate("text",x=4, y=14, label=paste("NRMSE:",round(RMSE(libre_package$percent_time_under_54,
                                                               libre_package$X.54)/
...
under_70 <- ggplot(libre_package,aes(x = percent_time_under_70,y = X.70)) +
  ...
  ggtitle("% Time Under 70 mg/dL") +
  annotate("text",x=6, y=20, label=paste("NRMSE:",round(RMSE(libre_package$percent_time_under_70,
                                                               libre_package$X.70)/
...
tir_70_180 <- ggplot(libre_package,aes(x = percent_time_70_180,y = X70.180)) +
  ...
  ggtitle("% Time 70 - 180 mg/dL") +
  annotate("text",x=23, y=92, label=paste("NRMSE:",round(RMSE(libre_package$percent_time_70_180,
...
over_180 <- ggplot(libre_package,aes(x = percent_time_over_180,y = X.180)) +
  ...
  coord_fixed(ratio = 1,xlim = c(0,100),ylim = c(0,100)) +
  ggtitle("% Time Over 180 mg/dL") +
  annotate("text",x=25, y=90, label=paste("NRMSE:",round(RMSE(libre_package$percent_time_over_180,
                                                              libre_package$X.180)/
...
over_250 <- ggplot(libre_package,aes(x = percent_time_over_250,y = X.250)) +
  ...
  ggtitle("% Time Over 250 mg/dL") +
  annotate("text",x=20, y=72, label=paste("NRMSE:",round(RMSE(libre_package$percent_time_over_250,
                                                              libre_package$X.250)/
...
sd <- ggplot(libre_package,aes(x = standard_deviation,y = SD)) +
  ...
  ggtitle("Standard Deviation") +
  annotate("text",x=45, y=107.5, label=paste("NRMSE:",round(RMSE(libre_package$standard_deviation,
                                                              libre_package$SD)/
...
tir_40_50 <- ggplot(medtronic_package,aes(x = percent_time_40_50,y = X.40.50.)) +
  ...
  annotate("text",x=0.6, y=1.8, label=paste("NRMSE:",round(RMSE(medtronic_package$percent_time_40_50,
...
tir_50_70 <- ggplot(medtronic_package,aes(x = percent_time_50_70,y = X.50.70.)) +
  ...
  annotate("text",x=3, y=9.25, label=paste("NRMSE:",round(RMSE(medtronic_package$percent_time_50_70,
...
tir_70_180 <- ggplot(medtronic_package,aes(x = percent_time_70_180,y = X.70.180.TIR)) +
  ...
  ggtitle("% Time 70 - 180 mg/dL") +
  annotate("text",x=50, y=85, label=paste("NRMSE:",round(RMSE(medtronic_package$percent_time_70_180,
...
tir_180_250 <- ggplot(medtronic_package,aes(x = percent_time_180_250,y = X.180.250.)) +
  ...
  annotate("text",x=12, y=42, label=paste("NRMSE:",round(RMSE(medtronic_package$percent_time_180_250,
...
tir_250_400 <- ggplot(medtronic_package,aes(x = percent_time_250_400,y = X.250.400.)) +
  ...
  annotate("text",x=10, y=32, label=paste("NRMSE:",round(RMSE(medtronic_package$percent_time_250_400,
