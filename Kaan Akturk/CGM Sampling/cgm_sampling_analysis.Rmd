...
knitr::opts_knit$set(root.dir = "/run/user/1000/gvfs/smb-share:server=ucdenver.pvt,share=som/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Kaan Akturk/CGM Sampling")
library(arsenal)
library(skimr)
library(knitr)
library(cgmanalysis)
