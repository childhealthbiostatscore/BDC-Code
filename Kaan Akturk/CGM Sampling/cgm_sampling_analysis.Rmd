...
knitr::opts_knit$set(root.dir = "C:/Users/timbv/Dropbox/Documents/Work/CGM Sampling")
library(arsenal)
library(skimr)
library(knitr)
library(cgmanalysis)
...
### All CGM sampling percentage faceted by metric
...
plot1[,c(1,3:length(all))] <- 
  lapply(plot1[,c(1,3:length(all))],as.numeric)
