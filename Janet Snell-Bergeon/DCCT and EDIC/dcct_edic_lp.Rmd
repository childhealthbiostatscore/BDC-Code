...
# remaining issues
# data are log transformed - OK for limma, but what about Pls-da and LASSO
...
plsda_carv_20 <- splsda(df[,names(df) %in% protnames], Y=as.factor(df$CARV),ncomp = 2,keepX = 20)
...
```{r, echo=FALSE,eval=FALSE}
# plsda.perf = perf(plsda_carv, validation = 'Mfold', folds = 5, 
