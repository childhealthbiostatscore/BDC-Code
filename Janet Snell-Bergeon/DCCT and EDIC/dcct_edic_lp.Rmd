...
write.csv(results_cvd_males,"B:\\Projects\\Janet Snell-Bergeon\\CACTI DCCT EDIC omics R01\\Proteomics\\Reports\\DCCT EDIC CARV males.csv")
...
write.csv(results_cvd_females,"B:\\Projects\\Janet Snell-Bergeon\\CACTI DCCT EDIC omics R01\\Proteomics\\Reports\\DCCT EDIC CARV females.csv")
# ADJUSTED FOR TX
...
write.csv(results_cvd_adj_males,"B:\\Projects\\Janet Snell-Bergeon\\CACTI DCCT EDIC omics R01\\Proteomics\\Reports\\DCCT EDIC CARV adjusted GROUP males.csv")
...
write.csv(results_cvd_adj_females,"B:\\Projects\\Janet Snell-Bergeon\\CACTI DCCT EDIC omics R01\\Proteomics\\Reports\\DCCT EDIC CARV adjusted GROUP females.csv")
...
write.csv(results_cvd_adj2_males,"B:\\Projects\\Janet Snell-Bergeon\\CACTI DCCT EDIC omics R01\\Proteomics\\Reports\\DCCT EDIC CARV adjusted GROUP VisitAge Visit Duration males.csv")
...
write.csv(results_cvd_adj2_females,"B:\\Projects\\Janet Snell-Bergeon\\CACTI DCCT EDIC omics R01\\Proteomics\\Reports\\DCCT EDIC CARV adjusted GROUP VisitAge Visit Duration females.csv")
...
plsda_carv_males <- splsda(males[,names(males) %in% protnames], Y=as.factor(males$CARV),ncomp = 1,keepX = c(15,15))

tune_females <- tune.splsda(females[,names(females) %in% protnames], Y=as.factor(females$CARV),ncomp = 4,validation = 'Mfold',
                                 folds = 3, dist = 'max.dist', progressBar = FALSE,
                                 measure = "BER", nrepeat = 10)
# optimal is 1 components, top 5 proteins
plsda_carv_females <- splsda(females[,names(females) %in% protnames], Y=as.factor(females$CARV),ncomp = 1,keepX = 5)
...
With only one component retained by the model, it is not possible to generate an individual plot.
...
# Loadings of top 5 proteins in terms of discrimination of CARV, for component 1, females only
