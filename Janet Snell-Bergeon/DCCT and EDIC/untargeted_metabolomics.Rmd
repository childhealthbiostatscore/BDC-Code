...
# Read in raw data
raw_data <- 
  read.csv("/Volumes/BDC/Projects/Janet Snell-Bergeon/CACTI DCCT EDIC omics R01/Metabolomics/EDIC metabolomics final data matrix.csv",
...
# below is where I stopped - need to merge in the clinical information and group information
# Add clinical data
