...
p <- ggplot(sdata_long, aes(x=variable,y=value,fill=sex)) + geom_boxplot() +
  xlab("") + ylab("") + theme(axis.text.x=element_text(angle=45, vjust = 0.5)) + scale_fill_manual(values=c("#ed2213","#809fd1"))
