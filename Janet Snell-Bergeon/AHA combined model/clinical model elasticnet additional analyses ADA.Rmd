...
null_mod = lm(formula = n_death,data = df)
kable(tidy(null_mod),digits = 3)
```
...
null_mod = lm(formula = n_cad,data = df)
kable(tidy(null_mod),digits = 3)
```
...
null_mod = lm(formula = n_hard_cad,data = df)
kable(tidy(null_mod),digits = 3)
```
...
null_mod = lm(formula = n_cvd,data = df)
kable(tidy(null_mod),digits = 3)
```
...
null_mod = lm(formula = n_hard_cvd,data = df)
kable(tidy(null_mod),digits = 3)
```
