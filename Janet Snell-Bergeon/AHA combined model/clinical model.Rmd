...
# need to exclude anyone who has duplicate SNP data
omics_data <- df[,c("StudyID",snps,"gly_P02671.7","gly_P02671.5","gly_P02671.4","gly_P02671.3","AAA01201000179.0807263.4","gly_P02679",
...
omics_data_has_snps <- omics_data[!is.na(omics_data$rs10949670) & !is.na(omics_data$rs4450463) & !is.na(omics_data$rs4796649)
                                  & !is.na(omics_data$rs6554207) & !is.na(omics_data$rs9503009),]
...
ada_data_has_snps <- ada_data[!is.na(ada_data$rs10949670) & !is.na(ada_data$rs4450463) & !is.na(ada_data$rs4796649)
                                  & !is.na(ada_data$rs6554207) & !is.na(ada_data$rs9503009),]
...
ada_data <- ada_data[,c("StudyID",snps,"gly_P02671.7","gly_P02671.5","gly_P02671.4","gly_P02671.3","AAA01201000179.0807263.4","gly_P02679",
                    "HMDB00510161.0696402.9","AAA01201000179.0809235.7","gly_P02675.4","gly_P02675","gly_P02647","P02655","gly_P02647.1",
                    "HMDB00510161.0694436","gly_P02652","gly_P01009","gly_P01834.11","P01817","AcCa 10:3","HMDB0028822260.1378628.6",
                    "AAA01201000179.0807263.4","gly_P02671.3","gly_P02671.7","age", "onhypermeds", "onlipidmeds", "ldl", "smknum", "race", 
                    "cholV1", "duration_cat", "l.bmi", "l.avediabp", "l.hdlc","l.CKDepi", "l.ac", "l.insdoseperkg", "l.hba1c")]
