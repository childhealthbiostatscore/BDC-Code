...
c <- coxph(Surv(PersonYrsDeath,death) ~ onhypermeds + onstatinmeds + avediabp + avesystbp + CKDepi + ac + hba1c + apob + fib + pai1 + smknum, data=complete)
summary(c)
```
...
c <- coxph(Surv(PersonYrsDeath,death) ~ age + onhypermeds + onlipidmeds + avediabp + avesystbp + CKDepi + ac + hba1c + apob + fib + pai1 + smknum, data=complete)
summary(c)
```
