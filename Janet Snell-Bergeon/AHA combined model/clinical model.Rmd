...
sas_check <- read.sas7bdat("T:/Janet Snell-Bergeon/AHA collaborative grant/Combined predictive model/allvisits_cvdrisk.sas7bdat")
...
form_test <- easy_glinternet(df=test,outcome = "CACprogV3_num",id_vars = "StudyID",
                             fam = "binomial",cv_type = "loo",cores = 1)
...
form_test <- easy_glinternet(df=test,outcome = "cac_change_per_yr",id_vars = "StudyID",
                             fam="gaussian",cv_type = "loo",cores = 1)
```
