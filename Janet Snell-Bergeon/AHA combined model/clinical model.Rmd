...
form <- str_replace(form,"nhw","as.factor(nhw)")
form <- str_replace(form,"CACprogV3_num","as.factor(CACprogV3_num)")
...
## CAC progression - LASSO with interactions
...
## CAC progression - GLM using variables selected by LASSO with interactions
...
## CAC progression - LASSO of clinical variables, without interactions
...
## CAC progression - GLM using clinical variables selected by LASSO
...
## CAC progression - LASSO of clinical variables with interactions
...
## CAC progression - GLM using clinical variables selected by LASSO with interactions
...
## CAC progression - GLM using ASCVD 10 year risk

```{r, echo=FALSE, comment=""}
refit_mod = glm(as.factor(CACprogV3_num) ~ pcr_percent,data=complete_lipidmeds_egdr_components,family = binomial("logit"))
summary(refit_mod)
aic_values <- c(aic_values,refit_mod$aic)
...
## Change in CAC per year - GLM using variables selected by LASSO
...
## Change in CAC per year - LASSO with interactions
...
## Change in CAC per year - GLM using variables selected by LASSO with interactions
...
## Change in CAC per year - LASSO of clinical variables, without interactions
...
## Change in CAC per year - GLM using clinical variables selected by LASSO
...
## Change in CAC per year - LASSO of clinical variables with interactions
...
## Change in CAC per year - GLM using clinical variables selected by LASSO with interactions
...
## Change in CAC per year - GLM using ASCVD 10 year risk
...
## Death - Cox model using variables selected in regularized Cox model
...
## Death - LASSO of clinical variables, without interactions
...
## Death - Cox model using clinical variables selected by LASSO
...
## Death - Cox model with ASCVD 10 year risk
...
## CAD - Cox model using variables selected in regularized Cox model
...
## CAD - LASSO of clinical variables, without interactions
...
## CAD - Cox model using clinical variables selected by LASSO
...
## CAD - Cox model with ASCVD 10 year risk
...
## Hard CAD - Cox model using variables selected in regularized Cox model
...
## Hard CAD - LASSO of clinical variables, without interactions
...
## Hard CAD - Cox model using clinical variables selected by LASSO
...
## Hard CAD - Cox model with ASCVD 10 year risk
...
## CVD - Cox model using variables selected in regularized Cox model
...
## CVD - LASSO of clinical variables, without interactions
...
## CVD - Cox model using clinical variables selected by LASSO
...
## CVD - Cox model with ASCVD 10 year risk
...
## Hard CVD - Cox model using variables selected in regularized Cox model
...
## Hard CVD - LASSO of clinical variables, without interactions
...
## Hard CVD - Cox model using clinical variables selected by LASSO
...
## Hard CVD - Cox model with ASCVD 10 year risk
...
# write list of selected variables for Tim
write.csv(selected_vars,"./Janet Snell-Bergeon/AHA collaborative grant/Combined predictive model/selected_vars.csv")
# Plot
...
```{r, echo=FALSE, comment=""}
form_cacp_omics <- paste0(form_cacp,"+ AAA01201000179.0807263.4 + gly_P02671.7_sd + gly_P02671.3_sd + gly_P02671.5_sd + gly_P02671.4_sd")

refit_mod_omics = glm(as.formula(form_cacp_omics),ada_data_cacp_complete,family = binomial("logit"))
summary(refit_mod_omics)
or_refit_mod_omics <- round(exp(cbind(OR = coef(refit_mod_omics), confint(refit_mod_omics))),2)
or_refit_mod_omics
refit_mod_omics$aic
