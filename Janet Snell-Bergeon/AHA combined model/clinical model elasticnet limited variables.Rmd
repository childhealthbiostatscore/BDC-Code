...
# Remove clinical predictors
clinical_predictors = 
  clinical_predictors[which(!clinical_predictors %in% 
                              c( "crpV1","homoV1","pai1V1","fibV1","UA_V1",
                                 "whrV1","apobV1","l45vsfV1","l45sqfV1","PAT_V1"))]
# Log transform 
...
imp = mice(df[,c(selected,omics)], seed = 1017, m = 5,
