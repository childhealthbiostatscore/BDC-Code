...
temp = df[,c(untargeted_metabs,targeted_metabs,global_proteins,glycated_proteins,lipids)]
X = df[,-c(which(colMeans(is.na())>=0.8))]
...
DO WE NEED TO FILTER THOSE W/ TOO MUCH MISSING DATA, NEAR ZERO VARIANCE, ETC?  if so, add to below
