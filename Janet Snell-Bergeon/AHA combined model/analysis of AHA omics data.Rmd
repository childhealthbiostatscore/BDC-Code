...
set.seed(3654)
plsda.perf = auroc(splsda.utm,plot = F,print = F)
auc_true <- as.numeric(plsda.perf$Comp1[1])
...
aucs = parSapply(cl,1:n_perm, function(i){
  ...
  perf_plsda = auroc(plsda_res,plot = F,print = F)
  return(as.numeric(perf_plsda$Comp1[1]))
})
stopCluster(cl)
