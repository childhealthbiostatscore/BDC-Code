...
```{r echo=FALSE}
merall_use <- read.sas7bdat("/Volumes/som-1/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Janet Snell-Bergeon/BMD Lifespan/Data_raw/bmdlifespan.sas7bdat")
