...
test <- here("T:/Janet Snell-Bergeon/AHA collaborative grant/Metabolomics/Data_Cleaned","metabolomics_without_imputation.csv")
raw_data <- 
  read.csv(test,stringsAsFactors = F,na.strings = c("","NA"))
...
l = do.call(cbind,l)
write.csv(l,file = "C:/Users/tim/Desktop/pc_loadings.csv",
