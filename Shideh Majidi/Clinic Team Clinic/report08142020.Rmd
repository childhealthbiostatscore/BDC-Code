...
Control patients that had 4+ RTC visits did not have a significant change in A1c between RTC and post-RTC time periods (p=`r contrasts_1a[1,4]`).  Those with <4 visits had a significant increase in A1c between RTC and post-RTC time periods (p=`r contrasts_1a[2,4]`).
...
CTC patients that had 4+ RTC visits did not have a significant change in A1c between pre and post time periods (p=`r contrasts_1b[1,4]`).  Those with <4 visits had a significant increase in A1c between RTC and CTC time periods (p=`r contrasts_1b[2,4]`).
