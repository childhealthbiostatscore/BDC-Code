...
a1cs <- read.csv("/Volumes/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Shideh Majidi/Depression/Data_Cleaned/a1cs.csv")
library(arsenal)
library(VGAM)
library(nlme)
library(emmeans)
...
ggplot(a1cs[a1cs$days_from_screen>=0,],
  ...
  geom_point(shape = ".") +
  geom_smooth(method = "lm",aes(linetype = charttreatafter.factor),
              se = F,color = "black") + 
