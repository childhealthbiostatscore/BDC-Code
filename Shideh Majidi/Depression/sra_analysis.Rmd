...
source("/home/tim/Documents/GitHub/BDC-Code/Shideh Majidi/Depression/sra.r")
source("/home/tim/Documents/GitHub/Tim-and-Laura/tim_r_functions.R")
a1cs <- read.csv("/run/user/1000/gvfs/smb-share:server=ucdenver.pvt,share=som/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Shideh Majidi/Depression/Data_Cleaned/a1cs.csv")
library(arsenal)
library(VGAM)
library(nlme)
library(emmeans)
...
a1cs <- left_join(a1cs,temp[,c("record_id","screen_date","charttreatafter.factor",
...
ggplot(a1cs,aes(x = days_from_screen,y = A1cValue)) +
  geom_point() +
  geom_smooth(aes(color = charttreatafter.factor)) + 
  xlab("Days from Screening") + ylab("HbA1c (%)") +
  scale_color_discrete(name = "Evidence of Psych. Treat.") +
  theme_bw() 
```
