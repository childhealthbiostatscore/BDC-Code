...
a1c_mod <- lme(a1c ~ timepoint * control,random=~1|record_id,data = mixed,na.action = na.omit)
a1c_mod_rs <- lme(a1c ~ timepoint * control,random=~1|record_id/timepoint,data = mixed,na.action = na.omit)
```
