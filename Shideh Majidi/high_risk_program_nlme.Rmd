...
# a1c_mod <- lme(a1c ~ timepoint * control,random=~1+record_id|case_id,dat = mixed,na.action = na.omit) 

# Mixed model of change in average A1c before vs. during and during vs. after
