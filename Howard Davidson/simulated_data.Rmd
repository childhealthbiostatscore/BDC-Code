...
compare = function(simulated_data,core_ratio = 0.5,digits = 3){
  ...
  cl = makeForkCluster(round(core_ratio*detectCores()))
  results = parLapply(cl,simulated_data, function(s){
    d = s$simulated_data
    # Difacto
  ...
  stopCluster(cl)
  results = round(do.call(rbind,results),digits)
...
sims = lapply(1:n_sims, function(i){
  t = sim_data(seed = i,p_con = 0.05,N = 50,n = 30)
  return(t)
})
...
# Simulate multiple datasets
sims = lapply(1:n_sims, function(i){
  t = sim_data(seed = i,p_con = 0.05,N = 50,n = 100)
  return(t)
})
res = compare(simulated_data = sims)
```
...
# Simulate multiple datasets
sims = lapply(1:n_sims, function(i){
  t = sim_data(seed = i,p_con = 0.05,N = 50,n = 200)
  return(t)
})
res = compare(simulated_data = sims)
```
...
# Simulate multiple datasets
sims = lapply(1:n_sims, function(i){
  t = sim_data(seed = i,p_con = 0.05,N = 50,n = 500)
  return(t)
})
res = compare(simulated_data = sims)
```
...
# Simulate multiple datasets
sims = lapply(1:n_sims, function(i){
  t = sim_data(seed = i,p_con = 0.05,N = 100,n = 30)
  return(t)
})
res = compare(simulated_data = sims)
```
...
# Simulate multiple datasets
sims = lapply(1:n_sims, function(i){
  t = sim_data(seed = i,p_con = 0.05,N = 100,n = 100)
  return(t)
})
res = compare(simulated_data = sims)
```
...
# Simulate multiple datasets
sims = lapply(1:n_sims, function(i){
  t = sim_data(seed = i,p_con = 0.05,N = 100,n = 200)
  return(t)
})
res = compare(simulated_data = sims)
```
...
# Simulate multiple datasets
sims = lapply(1:n_sims, function(i){
  t = sim_data(seed = i,p_con = 0.05,N = 100,n = 500)
  return(t)
})
res = compare(simulated_data = sims)
```
...
# Simulate multiple datasets
sims = lapply(1:n_sims, function(i){
  t = sim_data(seed = i,p_con = 0.05,N = 200,n = 30)
  return(t)
})
res = compare(simulated_data = sims)
```
...
# Simulate multiple datasets
sims = lapply(1:n_sims, function(i){
  t = sim_data(seed = i,p_con = 0.05,N = 200,n = 100)
  return(t)
})
res = compare(simulated_data = sims)
```
...
# Simulate multiple datasets
sims = lapply(1:n_sims, function(i){
  t = sim_data(seed = i,p_con = 0.05,N = 200,n = 200)
  return(t)
})
res = compare(simulated_data = sims)
```
...
# Simulate multiple datasets
sims = lapply(1:n_sims, function(i){
  t = sim_data(seed = i,p_con = 0.05,N = 200,n = 500)
  return(t)
})
res = compare(simulated_data = sims)
```
...
# Simulate multiple datasets
sims = lapply(1:n_sims, function(i){
  t = sim_data(seed = i,p_con = 0.05,N = 500,n = 30)
  return(t)
})
res = compare(simulated_data = sims)
```
...
# Simulate multiple datasets
sims = lapply(1:n_sims, function(i){
  t = sim_data(seed = i,p_con = 0.05,N = 500,n = 100)
  return(t)
})
res = compare(simulated_data = sims)
```
...
# Simulate multiple datasets
sims = lapply(1:n_sims, function(i){
  t = sim_data(seed = i,p_con = 0.05,N = 500,n = 200)
  return(t)
})
res = compare(simulated_data = sims)
```
...
# Simulate multiple datasets
sims = lapply(1:n_sims, function(i){
  t = sim_data(seed = i,p_con = 0.05,N = 500,n = 500)
  return(t)
})
res = compare(simulated_data = sims)
```
