...
# Get the best models
res2 = svmlc$results
kable(head(res2[order(res2$Accuracy,decreasing = T),],5),row.names = F)
```

#### Radial Kernel Classifier with Class Weights

i think it thinks y is a factor?
...
# Get the best models
res5 = rf$results
kable(head(res5[order(res5$Accuracy,decreasing = T),],5),row.names = F)
```
