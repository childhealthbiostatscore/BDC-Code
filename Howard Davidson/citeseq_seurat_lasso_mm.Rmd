...
# expressions_df_idda1c = transformed_analysis_idda1c
...
glm1 <- try(glmmLasso(fix = testform,
                      rnd = list(donor=~1),
                      data = expressions_df_idda1c, lambda=lambda[j],switch.NR=FALSE,final.re=FALSE,
...
glm1_final <- glmmLasso(fix = testform,
                        rnd = list(donor=~1),
                        data = expressions_df_idda1c, lambda=lambda[opt],switch.NR=FALSE,final.re=FALSE)

glm1_final <- glmmLasso(fix = testform,
                        rnd = list(donor=~1),
                        data = expressions_df_idda1c, lambda=90,switch.NR=FALSE,final.re=FALSE)
