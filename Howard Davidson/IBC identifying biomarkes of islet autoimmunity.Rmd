...
- Originally published in XXXXXXX
...
- The ensemble ML algorithm selected 42 features, including 16 SNPs, with a cross-validated receiver operating characteristic area under the curve (AUC) of 0.74
- DIFAcTO selected 4 markers with AUC = 0.57
- Elastic net selected 17 markers with AUC = 0.67
...
- DIFAcTO, elastic net, and ensemble ML selected 2, 12, and 34 unique markers, respectively
...
- Advantages and disadvantages, including computational

### Conclusions

- need to talk about why EN may have selected larger models, see Zhou and Hastie - elastic net encourages a "grouping effect" where strong correlated predictors are kept in the model
...
- Only 5 markers in simulations

### Acknowledgments

- TEDDY study participants
- Funding from NIDDK, NIAID, NICHD, NIEHS, CDC, JDRF
- ML work performed at Pacific Northwest National Laboratory, operated by Battelle for the DOE
