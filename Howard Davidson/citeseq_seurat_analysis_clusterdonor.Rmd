...
predictors_a1c_slope_en = colnames(transformed_analysis_a1c_slope)[-1]

# elnet small subset
en_allnewgenes = easy_elasticnet(data = transformed_analysis_a1c_slope, outcome = "a1c_slope",cv_method = "loo",
