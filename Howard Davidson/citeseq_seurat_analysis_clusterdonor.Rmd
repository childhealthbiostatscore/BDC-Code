...
#   geom_point()+
#   geom_smooth(aes(y = pred_idda1c), method = "lm",color = "black") + theme_classic()
...
plot_model(idda1c_mixed_mod, terms = "visit_binned",type = "pred") + theme_classic() + geom_smooth(aes(y = IDDA1C_binned, x = visit_binned),data = idda1c_plot_df, method = "lm")
