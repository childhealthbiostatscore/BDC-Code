...
#source("D:/Repositories/shared-resources/Machine Learning/Tim - ElasticNet CV/easy_elasticnet_cs.R")
```
...
a1c_df$hwdid = a1c_df$`HWD ID`
a1c_df$age = a1c_df$`Age Co`
idda1c_mod_nogenes = lme(IDDA1C ~ Gender + age + BMI + visit,
            random = ~1|hwdid,
            data = a1c_df,
            na.action = na.omit)
