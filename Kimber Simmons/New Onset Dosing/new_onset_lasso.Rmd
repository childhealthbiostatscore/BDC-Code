...
Week 1 bolus values were assumed to be independent of TDD. For each participant, we calculated $$y_i = \text{Correction}_i*\text{TDD}_i$$. Next, we regressed $y_i$ (the numerator in the correction equation) on age, to see if there was an association with age.
...
# Categorical age
df$age_cat = cut(df$Age,c(12,36,120,Inf),labels = c("Toddler","Elementary","Adolescent"))
# Association with age
...
b = boot(data = y,statistic = m,R = 1000,parallel = "multicore",ncpus = 8)
```
