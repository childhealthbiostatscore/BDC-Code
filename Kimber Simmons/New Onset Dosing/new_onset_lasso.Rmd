...
df = read.csv("/Volumes/som/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Kimber Simmons/New Onset Dosing/Data_Cleaned/cleaned_data.csv",stringsAsFactors = T)
df = df %>% select(Age,Sex,Race,Initial_A1c,DKA,Wt_onset,Average_TDD)
df = df[complete.cases(df),]
Y = df$Average_TDD
X = df %>% select(Age,Sex,Race,Initial_A1c,DKA,Wt_onset)
