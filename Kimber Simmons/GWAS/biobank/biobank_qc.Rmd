...
knitr::opts_knit$set(root.dir = "/Users/timvigers/simmons/biobank")
library(tidyverse)
```
...
# Post-deletion
indmiss_check <- read.table(file="./miss_post_del.imiss",header=TRUE)
snpmiss_check <- read.table(file="./miss_post_del.lmiss",header=TRUE)
# Plots
