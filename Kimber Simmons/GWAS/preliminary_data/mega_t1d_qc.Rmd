...
# MDS
plink --bfile final_merge --cluster --mds-plot 10 --out final_merge_mds
...
plink --bfile final_merge --covar covar_mds.txt --hide-covar --logistic --out logistic_results
# Permutation testing
plink --bfile final_merge --logistic --model mperm=1000000 --out perm_result
```
