...
knitr::opts_knit$set(root.dir = "C:/Users/timbv/Desktop/simmons")
library(knitr)
library(qqman)
library(biomaRt)
library(tidyverse)
...
bm <- getBM(attributes = c('refsnp_id', 'allele', 'chrom_start',
                           'chrom_strand'), filters = c("snp_filter"),
            values = merged_snps$V2,mart = snp_mart)
```
