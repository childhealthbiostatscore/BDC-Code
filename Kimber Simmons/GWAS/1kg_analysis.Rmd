...
write.table(cbind(locations_w$chr_name,locations_w$chrom_start,locations_w$chrom_start),
            file = "~/Dropbox/Work/Kimber Simmons/GWAS/Data_Cleaned/snp_locations_38",
...
write.table(cbind(locations37_w$chr_name,locations37_w$chrom_start,locations37_w$chrom_start),
            file = "~/Dropbox/Work/Kimber Simmons/GWAS/Data_Cleaned/snp_locations_37",
            row.names = F,quote = F,col.names = F)
