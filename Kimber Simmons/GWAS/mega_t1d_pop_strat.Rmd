...
# Find common SNPs
kimber = read.delim("/Volumes/som/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Kimber Simmons/GWAS/Data_Cleaned/population_stratification/Simmons_passed_qc.bim", 
                    header=F, quote="")
tgp = read.delim("/Volumes/som/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Kimber Simmons/GWAS/Data_Cleaned/population_stratification/1kG_MDS4.bim", header=F, quote="")
common.snps = which(tgp$V2 %in% kimber$V2)
common.snps <- as.character(tgp$V2[common.snps])

alleles = read.table("/Volumes/som/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Kimber Simmons/GWAS/Data_Cleaned/population_stratification/Simmons_passed_qc.frq",
                     header=T)
...
write.table(snps,file="/Volumes/som/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Kimber Simmons/GWAS/Data_Cleaned/population_stratification/list.snps", 
...
kimber <- read.csv("/Volumes/som/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Kimber Simmons/GWAS/Data_Cleaned/population_stratification/clinical.csv")
# Match to .fam IDs
fam <- read.table(file="/Volumes/som/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Kimber Simmons/GWAS/Data_Cleaned/population_stratification/Simmons_MDS.fam",header=F)
...
# Reference races
race<- read.csv(file="/Volumes/som/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Kimber Simmons/GWAS/Data_Cleaned/population_stratification/race_1kG.csv",
                stringsAsFactors = F)
...
data<- read.table(file="/Volumes/som/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Kimber Simmons/GWAS/Data_Cleaned/population_stratification/PCA.eigenvec",
                  header=FALSE)
...
```{r scree,echo=FALSE}
scree <- read.table("/Volumes/som/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/BDC/Projects/Kimber Simmons/GWAS/Data_Cleaned/population_stratification/PCA.eigenval")
colnames(scree) <- "var"
