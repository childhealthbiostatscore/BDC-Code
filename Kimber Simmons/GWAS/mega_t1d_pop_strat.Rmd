...
plink2 --pgen plink_TGP/all_phase3_ns.pgen --pvar plink_TGP/all_phase3_ns.pvar.zst --psam plink_TGP/phase3_corrected.psam --maf 0.05 --make-bed --out plink_TGP/all_phase3_ns --max-alleles 2
```
...
plink --bfile plink_TGP/all_phase3_ns --geno 0.2 --allow-no-sex --make-bed --out kimber/population_stratification/1kG_MDS --allow-extra-chr
...
plink --bfile 1kG_MDS5 --allow-extra-chr --allow-no-sex --autosome --make-bed --out 1kG_MDS6 --memory 6144 --filter-founders
# Relatedness
