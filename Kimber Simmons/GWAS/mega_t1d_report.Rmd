...
indmiss <-read.table(file="/Users/timvigers/kimber_gwas/Data_Cleaned/plink.imiss",
                    header=TRUE)
snpmiss <-read.table(file="/Users/timvigers/kimber_gwas/Data_Cleaned/plink.lmiss",
                    header=TRUE)
# Post-deletion
indmiss_check <-
  read.table(file="/Users/timvigers/kimber_gwas/Data_Cleaned/Simmons_redo_check_miss.imiss",
                    header=TRUE)
snpmiss_check <-
  read.table(file="/Users/timvigers/kimber_gwas/Data_Cleaned/Simmons_redo_check_miss.lmiss",
                    header=TRUE)
# Gender file
gender <- read.table("/Users/timvigers/kimber_gwas/Data_Cleaned/plink.sexcheck",
                     header=T,as.is=T)
```
