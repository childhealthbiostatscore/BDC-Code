...
```{bash plink call rate,eval=FALSE}
...
plink --bfile Simmons_combined_6 --remove het_fail_ind.txt --make-bed --out Simmons_combined_7
plink --bfile Simmons_combined_7 --extract indepSNP.prune.in --het --out R_check_post
```
...
plink --bfile Simmons_combined_7 --genome --min 0.05
```
