...
tab.any.caid<-final_table(dat,c('Age_AtDX','Gender','RaceEthinicity_cat','BMI_AtDX',
                                ...
                                'baseline_tpo','baseline_thy','baseline_ttg','baseline_21'),
...
###timing table:
tab.time<-final_table(dat,c('caid_months_if_yes',
...
kable(sum.forkimber, align = c("l", "l"))
```
