...
#THYROID:
tab.thy<-final_table(dat.thy,c('Age_AtDX','Gender','RaceEthinicity_cat','BMI_AtDX'),
                     dat.thy$thyroid_yn,margin=2,single=F,2,col.names=T, summary.stat='mean')

tab.thy

#CELIAC:
tab.cel<-final_table(dat.cel,c('Age_AtDX','Gender','RaceEthinicity_cat','BMI_AtDX'),
                     dat.cel$celiac_yn,margin=2,single=F,2,col.names=T, summary.stat='mean')
...
###timing table:
tab.time<-final_table(dat,c('which_caid', 'caid_days_if_yes',
                            'thyroid_timing','thyroid_days_if_yes',
                            'celiac_timing','celiac_days_if_yes',
                            'addison_timing','addison_days_if_yes',
                            'followup'),
