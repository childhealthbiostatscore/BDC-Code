...
tab.celiac.repeat<-final_table(dat,c('num_ttg','length_testing','avg_testing',
                                     'tot_pos_ttg','tot_neg_ttg','tot_neg_inarow'),
                     dat$EPICMRN,margin=2,single=F,2,col.names=T, summary.stat='median')
tab.celiac.repeat
...
**TTG Timing**
```{r,echo=FALSE,message=FALSE,results='asis',warning=FALSE}
kable(tab.celiac.repeat, align = c("l", "l"))
```
