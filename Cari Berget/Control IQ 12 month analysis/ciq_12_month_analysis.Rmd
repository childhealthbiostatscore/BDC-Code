...
There is not a huge amount of variability in this outcome, which is disrupting the models. The singular boundary warning indicates that the random intercept is difficult to estimate, likely because there is so little between subject variance. 
