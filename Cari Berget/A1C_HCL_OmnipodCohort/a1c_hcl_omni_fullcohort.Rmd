...
fit_gly_mod = function(outcome,df){
  ...
  print(kable(mod_means$contrasts[5:7,],digits = 3,caption = "Timepoint Contrasts"))
  print(kable(mod_means2,digits = 3,caption = "Timepoint Means"))
 #print(kable(mod_means$contrasts[c(3,8,12),],caption="Time point means.",format.args = list(scientific = FALSE)))
...
# timepoints
tps = c("child_bl_arm_1", "child_m1_arm_1", "child_m3_arm_1", "child_m6_arm_1", "child_m12_arm_1")
...
psy_soc_child_fu = analysis_raw %>% select(record_id,redcap_event_name, c_f_timepoint:c_f_inspire17,
                                           ya_f_header_timepoint:ya_f_inspire17, seeds_fu1:seeds_fu20) %>% filter(redcap_event_name %in% c("child_m1_arm_1","child_m3_arm_1","child_m6_arm_1", "child_m12_arm_1"))
...
psy_soc_p_fu = analysis_raw %>% select(record_id,redcap_event_name, p_f_inspire1:p_f_inspire21, p_f_hfs_behave1:p_f_hfs_worry26,
                                       p_f_paid1:p_f_paid18) %>% filter(redcap_event_name %in% c("parent_m1_arm_1","parent_m3_arm_1","parent_m6_arm_1", "parent_m12_arm_1"))
...
analysis$redcap_event_name = factor(analysis$redcap_event_name, levels = c("child_bl_arm_1","child_m1_arm_1","child_m3_arm_1","child_m6_arm_1", "child_m12_arm_1"),
                                    labels = c("Baseline", "Month 1", "Month 3", "Month 6", "Month 12"))
# discontinuation
