...
knitr::opts_knit$set(root.dir = "home/tim/Dropbox/Documents/Work/670G Combined")
library(Hmisc)
library(arsenal)
library(skimr)
library(mice)
...
# Table 1
t1 <- tableby(cohort ~ hba1c_baseline + hba1c_group + age + age_group + 
                sex + race + insurance,data = demographics)
# Print
